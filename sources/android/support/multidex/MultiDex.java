...
public final class MultiDex {
    ...
    public static void install(Context context) {
        ...
        if (IS_VM_MULTIDEX_CAPABLE) {
            ...
            throw new RuntimeException("MultiDex installation failed. SDK " + VERSION.SDK_INT + " is unsupported. Min SDK version is " + 4 + Consts.DOT);
        } else {
            try {
    ...
    public static void installInstrumentation(Context instrumentationContext, Context targetContext) {
        ...
        if (IS_VM_MULTIDEX_CAPABLE) {
            ...
            try {
                ...
                String instrumentationPrefix = instrumentationContext.getPackageName() + Consts.DOT;
