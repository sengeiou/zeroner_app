...
class TypefaceCompatApi21Impl extends TypefaceCompatBaseImpl {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:45:0x0062 A[ExcHandler: all (th java.lang.Throwable), Splitter:B:7:0x001a] */
    ...
    public android.graphics.Typeface createFromFontInfo(android.content.Context r12, android.os.CancellationSignal r13, @android.support.annotation.NonNull android.support.v4.provider.FontsContractCompat.FontInfo[] r14, int r15) {
        ...
        L_0x0043:
            r7 = move-exception
            com.google.devtools.build.android.desugar.runtime.ThrowableExtension.addSuppressed(r8, r7)     // Catch:{ IOException -> 0x0048 }
            goto L_0x0005
        L_0x0048:
            r1 = move-exception
            r6 = 0
        ...
        L_0x004b:
            r9 = move-exception
            com.google.devtools.build.android.desugar.runtime.ThrowableExtension.addSuppressed(r7, r9)     // Catch:{ Throwable -> 0x0050, all -> 0x0062 }
            goto L_0x003b
        L_0x0050:
            r6 = move-exception
        ...
        L_0x0095:
            r8 = move-exception
            com.google.devtools.build.android.desugar.runtime.ThrowableExtension.addSuppressed(r7, r8)     // Catch:{ IOException -> 0x0048 }
            goto L_0x005d
        L_0x009a:
            r4.close()     // Catch:{ IOException -> 0x0048 }
            goto L_0x005d
