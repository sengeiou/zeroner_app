...
public final class FontRequest {
    ...
    public FontRequest(@NonNull String providerAuthority, @NonNull String providerPackage, @NonNull String query, @NonNull List<List<byte[]>> certificates) {
        ...
        this.mIdentifier = new StringBuilder(this.mProviderAuthority).append(HelpFormatter.DEFAULT_OPT_PREFIX).append(this.mProviderPackage).append(HelpFormatter.DEFAULT_OPT_PREFIX).append(this.mQuery).toString();
    }
