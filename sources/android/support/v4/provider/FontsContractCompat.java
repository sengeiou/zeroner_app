...
public class FontsContractCompat {
    ...
    public static android.graphics.Typeface getFontSync(final android.content.Context r9, final android.support.v4.provider.FontRequest r10, @android.support.annotation.Nullable final android.support.v4.content.res.ResourcesCompat.FontCallback r11, @android.support.annotation.Nullable final android.os.Handler r12, boolean r13, int r14, final int r15) {
        ...
        L_0x0049:
            ...
            android.support.v4.provider.SelfDestructiveThread r7 = sBackgroundThread     // Catch:{ InterruptedException -> 0x005b }
        ...
        L_0x0061:
            ...
            monitor-enter(r8)
            android.support.v4.util.SimpleArrayMap<java.lang.String, java.util.ArrayList<android.support.v4.provider.SelfDestructiveThread$ReplyCallback<android.support.v4.provider.FontsContractCompat$TypefaceResult>>> r7 = sPendingReplies     // Catch:{ all -> 0x007c }
