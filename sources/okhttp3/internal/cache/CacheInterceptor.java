...
public final class CacheInterceptor implements Interceptor {
    ...
    static boolean isContentSpecificHeader(String fieldName) {
        return "Content-Length".equalsIgnoreCase(fieldName) || com.google.common.net.HttpHeaders.CONTENT_ENCODING.equalsIgnoreCase(fieldName) || "Content-Type".equalsIgnoreCase(fieldName);
    }
}
