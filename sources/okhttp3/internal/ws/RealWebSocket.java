...
public final class RealWebSocket implements WebSocket, FrameCallback {
    ...
    public void connect(OkHttpClient client) {
        ...
        final Request request = this.originalRequest.newBuilder().header(HttpHeaders.UPGRADE, "websocket").header(HttpHeaders.CONNECTION, HttpHeaders.UPGRADE).header("Sec-WebSocket-Key", this.key).header("Sec-WebSocket-Version", Constants.VIA_REPORT_TYPE_JOININ_GROUP).build();
