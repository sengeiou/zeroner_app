...
public class Highlight {
    ...
    public Highlight(float x, float y, float xPx, float yPx, int dataSetIndex, AxisDependency axis2) {
        this.mX = Float.NaN;
        this.mY = Float.NaN;
        this.mDataIndex = -1;
        this.mStackIndex = -1;
    ...
    public Highlight(float x, float y, float xPx, float yPx, int dataSetIndex, int stackIndex, AxisDependency axis2) {
