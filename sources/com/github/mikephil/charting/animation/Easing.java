...
public class Easing {
    ...
    public static final EasingFunction EaseInElastic = new EasingFunction() {
        public float getInterpolation(float input) {
            ...
            return -(((float) Math.pow(2.0d, (double) (10.0f * input2))) * ((float) Math.sin((double) (((input2 - ((0.3f / Easing.DOUBLE_PI) * ((float) Math.asin(1.0d)))) * Easing.DOUBLE_PI) / 0.3f))));
        }
    };
    ...
    public static final EasingFunction EaseInOutBack = new EasingFunction() {
        public float getInterpolation(float input) {
            ...
            if (input2 < 1.0f) {
                ...
                return input2 * input2 * (((1.0f + s) * input2) - s) * 0.5f;
            }
            float input3 = input2 - 2.0f;
            float s2 = 1.70158f * 1.525f;
            return ((input3 * input3 * (((1.0f + s2) * input3) + s2)) + 2.0f) * 0.5f;
        }
    };
    ...
    public static final EasingFunction EaseInOutCirc = new EasingFunction() {
        public float getInterpolation(float input) {
            float input2 = input * 2.0f;
            if (input2 < 1.0f) {
                return -0.5f * (((float) Math.sqrt((double) (1.0f - (input2 * input2)))) - 1.0f);
            }
            float input3 = input2 - 2.0f;
            return 0.5f * (((float) Math.sqrt((double) (1.0f - (input3 * input3)))) + 1.0f);
        }
    };
    ...
    public static final EasingFunction EaseInOutElastic = new EasingFunction() {
        public float getInterpolation(float input) {
            ...
            if (input2 < 1.0f) {
                ...
                return -0.5f * ((float) Math.sin((double) (((1.0f * input3) - s) * Easing.DOUBLE_PI * 2.2222223f))) * ((float) Math.pow(2.0d, (double) (10.0f * input3)));
            }
            float input4 = input2 - 1.0f;
            return (0.5f * ((float) Math.pow(2.0d, (double) (-10.0f * input4))) * ((float) Math.sin((double) (((input4 * 1.0f) - s) * Easing.DOUBLE_PI * 2.2222223f)))) + 1.0f;
        }
    };
    public static final EasingFunction EaseInOutExpo = new EasingFunction() {
        public float getInterpolation(float input) {
            ...
            float input2 = input * 2.0f;
            if (input2 < 1.0f) {
                return ((float) Math.pow(2.0d, (double) (10.0f * (input2 - 1.0f)))) * 0.5f;
            }
            return ((-((float) Math.pow(2.0d, (double) (-10.0f * (input2 - 1.0f))))) + 2.0f) * 0.5f;
        }
    };
    public static final EasingFunction EaseInOutQuad = new EasingFunction() {
        public float getInterpolation(float input) {
            ...
            float input3 = input2 - 1.0f;
            return -0.5f * (((input3 - 2.0f) * input3) - 1.0f);
        }
    };
    public static final EasingFunction EaseInOutQuart = new EasingFunction() {
        public float getInterpolation(float input) {
            float input2 = input * 2.0f;
            if (input2 < 1.0f) {
                return 0.5f * ((float) Math.pow((double) input2, 4.0d));
            }
            return -0.5f * (((float) Math.pow((double) (input2 - 2.0f), 4.0d)) - 2.0f);
        }
    };
    ...
    public static final EasingFunction EaseOutBounce = new EasingFunction() {
        public float getInterpolation(float input) {
            ...
            if (input < 0.72727275f) {
                ...
                return (7.5625f * input2 * input2) + 0.75f;
            } else if (input < 0.90909094f) {
                float input3 = input - 0.8181818f;
                return (7.5625f * input3 * input3) + 0.9375f;
            } else {
                float input4 = input - 0.95454544f;
                return (7.5625f * input4 * input4) + 0.984375f;
            }
        }
    };
