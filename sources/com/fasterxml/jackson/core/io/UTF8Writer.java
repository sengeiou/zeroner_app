...
public final class UTF8Writer extends Writer {
    ...
    /* JADX WARNING: Incorrect type for immutable var: ssa=char, code=int, for r0v0, types: [int, char] */
    ...
    public void write(int c) throws IOException {
        ...
        if (c < 2048) {
            int ptr3 = ptr2 + 1;
            this._outBuffer[ptr2] = (byte) ((c >> 6) | Opcodes.AND_LONG_2ADDR);
            ptr = ptr3 + 1;
            this._outBuffer[ptr3] = (byte) ((c & 63) | 128);
        } else if (c <= 65535) {
            int ptr4 = ptr2 + 1;
            this._outBuffer[ptr2] = (byte) ((c >> 12) | Opcodes.SHL_INT_LIT8);
            int ptr5 = ptr4 + 1;
        ...
        if (len >= 2) {
            ...
            while (true) {
                ...
                if (c < 2048) {
                    ...
                    outBuf[outPtr] = (byte) ((c >> 6) | Opcodes.AND_LONG_2ADDR);
                    ...
                    outBuf[outPtr] = (byte) ((c >> 12) | Opcodes.SHL_INT_LIT8);
