...
public class UTF8JsonGenerator extends JsonGeneratorImpl {
    ...
    public UTF8JsonGenerator(IOContext ctxt, int features, ObjectCodec codec, OutputStream out) {
        ...
        if (isEnabled(Feature.ESCAPE_NON_ASCII)) {
            setHighestNonEscapedChar(Opcodes.NEG_FLOAT);
        }
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:12:0x0027, code lost:
        ...
        r4 = r6._outputTail;
        r6._outputTail = r4 + 1;
        r3[r4] = (byte) ((r0 >> 6) | com.tencent.tinker.android.dx.instruction.Opcodes.AND_LONG_2ADDR);
        r3 = r6._outputBuffer;
        r4 = r6._outputTail;
        r6._outputTail = r4 + 1;
        r3[r4] = (byte) ((r0 & '?') | 128);
    ...
    public void writeRaw(char ch) throws IOException, JsonGenerationException {
        ...
        if (ch <= 127) {
            ...
            int i2 = this._outputTail;
            this._outputTail = i2 + 1;
            bbuf[i2] = (byte) ((ch >> 6) | Opcodes.AND_LONG_2ADDR);
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:9:0x001f, code lost:
        r4 = r6._outputTail;
        r6._outputTail = r4 + 1;
        r0[r4] = (byte) ((r1 >> 6) | com.tencent.tinker.android.dx.instruction.Opcodes.AND_LONG_2ADDR);
        r4 = r6._outputTail;
        r6._outputTail = r4 + 1;
        r0[r4] = (byte) ((r1 & '?') | 128);
     */
        ...
        while (offset2 < end) {
            ...
            if (ch > 127) {
                if (ch <= 2047) {
                    ...
                    outputBuffer[outputPtr3] = (byte) ((ch >> 6) | Opcodes.AND_LONG_2ADDR);
    ...
    public void _writeBinary(Base64Variant b64variant, byte[] input, int inputPtr, int inputEnd) throws IOException, JsonGenerationException {
        ...
        if (inputLeft > 0) {
            ...
            if (inputLeft == 2) {
                b24 |= (input[inputPtr6] & UnsignedBytes.MAX_VALUE) << 8;
                int i3 = inputPtr6 + 1;
            }
    ...
    public int _writeBinary(Base64Variant b64variant, InputStream data, byte[] readBuffer, int bytesLeft) throws IOException, JsonGenerationException {
        ...
        if (inputPtr5 < inputEnd2) {
            b24 |= (readBuffer[inputPtr5] & UnsignedBytes.MAX_VALUE) << 8;
            amount = 2;
        } else {
            amount = 1;
        }
    ...
    private int _outputRawMultiByteChar(int ch, char[] cbuf, int inputOffset, int inputLen) throws IOException {
        if (ch < SURR1_FIRST || ch > SURR2_LAST) {
            ...
            int i = this._outputTail;
            this._outputTail = i + 1;
            bbuf[i] = (byte) ((ch >> 12) | Opcodes.SHL_INT_LIT8);
            int i2 = this._outputTail;
            this._outputTail = i2 + 1;
    ...
    private int _outputMultiByteChar(int ch, int outputPtr) throws IOException {
        ...
        if (ch < SURR1_FIRST || ch > SURR2_LAST) {
            ...
            bbuf[outputPtr] = (byte) ((ch >> 12) | Opcodes.SHL_INT_LIT8);
            int outputPtr3 = outputPtr2 + 1;
