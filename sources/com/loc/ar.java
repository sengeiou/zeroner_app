...
public final class ar extends SQLiteOpenHelper {
    ...
    public static class a extends ContextWrapper {
        ...
        public final java.io.File getDatabasePath(java.lang.String r7) {
            /*
                r6 = this;
                boolean r0 = com.loc.ar.b     // Catch:{ Throwable -> 0x00a7 }
                if (r0 == 0) goto L_0x0011
                android.content.Context r0 = r6.b     // Catch:{ Throwable -> 0x00a7 }
                java.lang.String r1 = "android.permission.WRITE_EXTERNAL_STORAGE"
                boolean r0 = com.loc.w.a(r0, r1)     // Catch:{ Throwable -> 0x00a7 }
            ...
            L_0x0040:
                boolean r0 = com.loc.ar.c     // Catch:{ Throwable -> 0x00a7 }
                if (r0 == 0) goto L_0x004c
                boolean r0 = com.loc.ar.b     // Catch:{ Throwable -> 0x00a7 }
                if (r0 != 0) goto L_0x0081
            L_0x004c:
                com.loc.ar.c = true     // Catch:{ Throwable -> 0x00a7 }
                java.lang.StringBuilder r0 = new java.lang.StringBuilder     // Catch:{ Throwable -> 0x00a7 }
                r0.<init>()     // Catch:{ Throwable -> 0x00a7 }
                java.lang.String r1 = r6.a     // Catch:{ Throwable -> 0x00a7 }
                java.lang.StringBuilder r0 = r0.append(r1)     // Catch:{ Throwable -> 0x00a7 }
            ...
            L_0x0091:
                ...
                goto L_0x0015
            L_0x0099:
                com.loc.ar.b = false     // Catch:{ Throwable -> 0x00a7 }
                java.io.File r0 = super.getDatabasePath(r7)     // Catch:{ Throwable -> 0x00a7 }
                goto L_0x0015
            L_0x00a2:
                r2 = move-exception
            ...
            L_0x00b1:
                ...
                goto L_0x0091
            */
            throw new UnsupportedOperationException("Method not decompiled: com.loc.ar.a.getDatabasePath(java.lang.String):java.io.File");
        }
    ...
    public ar(Context context, String str, an anVar) {
