...
public final class c {
    ...
    public static int a(String str, List<GeoFence> list, Bundle bundle) {
        try {
            ...
            for (int i = 0; i < optJSONArray.length(); i++) {
                ...
                poiItem.setPoiName(jSONObject2.optString(TableSchema.COLUMN_NAME));
    ...
    private List<DPoint> a(List<DPoint> list, float f) {
        ...
        while (true) {
            ...
            if (longitude2 < Utils.DOUBLE_EPSILON || z) {
            ...
            double a2 = (double) dr.a(new DPoint(dPoint3.getLatitude(), dPoint3.getLongitude()), new DPoint(d2, d));
            if (a2 > d3) {
                i2 = i3;
                d3 = a2;
            }
    ...
    public final int c(String str, List<GeoFence> list, Bundle bundle) {
        ...
        try {
            ...
            for (int i2 = 0; i2 < optJSONArray.length(); i2++) {
                ...
                String optString3 = jSONObject2.optString(TableSchema.COLUMN_NAME);
