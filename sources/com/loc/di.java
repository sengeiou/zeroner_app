...
public final class di {
    ...
    static String b = "";
    static String c = "001;11B;11C;11F;11G;11H;11I;11K;122;135;13J;13S;14S;157;15O;15U";
    public static String d = null;
    public static String e = null;
    public static int f = a.MAX_USERDATA_VALUE_LENGTH;
    ...
    public static v a(String str, String str2) {
        boolean z = false;
        try {
            return new v.a(str, str2, "AMAP_Location_SDK_Android 4.7.0").a(e()).a();
        } catch (Throwable th) {
    ...
    public static void a(Context context) {
        try {
            ...
            String a2 = cx.a(l.f(context));
            i = a2;
            if (a2 == null) {
                return;
            }
            if (a2.length() != 0 && j != null && j.containsKey(a2)) {
                String str = (String) j.get(a2);
                String str2 = (str == null || str.length() <= 0) ? null : new String(cx.d(a(str), a2), "utf-8");
    ...
    public static boolean a(com.amap.api.location.DPoint r29, java.util.List<com.amap.api.location.DPoint> r30) {
        ...
        L_0x0139:
            ...
            goto L_0x0123
        */
        throw new UnsupportedOperationException("Method not decompiled: com.loc.di.a(com.amap.api.location.DPoint, java.util.List):boolean");
    }
    ...
    private static byte[] a(String str) {
        ...
        for (int i2 = 0; i2 < length; i2++) {
            bArr[i2] = (byte) (dr.i(lowerCase.substring(i2 * 2, (i2 * 2) + 2)) & 255);
        }
        return bArr;
    }
    ...
    public static v b() {
        try {
            if (n == null) {
                n = new v.a("loc", "4.7.0", "AMAP_Location_SDK_Android 4.7.0").a(e()).a("4.7.0").a();
            }
        } catch (Throwable th) {
            a(th, "CoreUtil", "getSDKInfo");
        }
