...
public final class df {
    ...
    private void a(AMapLocationServer aMapLocationServer, String str, String str2, String str3, String str4, String str5, String str6, String str7) {
        ...
        if (!TextUtils.isEmpty(str4)) {
            sb.append(str4).append(MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR);
        }
        ...
        if (!TextUtils.isEmpty(str6)) {
            if (TextUtils.isEmpty(str7) || this.b.getGeoLanguage() == GeoLanguage.EN) {
                ...
                sb.append("靠近");
                sb.append(str6).append(MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR);
        ...
        if (adCode == null || adCode.trim().length() <= 0 || this.b.getGeoLanguage() == GeoLanguage.EN) {
            ...
            aMapLocationServer.setAddress(sb.toString().replace(MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR, ""));
        }
    }
    ...
    public final com.autonavi.aps.amapapi.model.AMapLocationServer a(com.autonavi.aps.amapapi.model.AMapLocationServer r12, byte[] r13) {
        ...
        L_0x0043:
            ...
            double r0 = r0 / r2
            double r0 = com.loc.dr.a(r0)     // Catch:{ Throwable -> 0x029c, all -> 0x02e8 }
        ...
        L_0x029e:
            ...
            com.loc.Cdo.a(r0, r2)     // Catch:{ all -> 0x02ea }
        ...
        L_0x0311:
            ...
            goto L_0x00b7
        */
        throw new UnsupportedOperationException("Method not decompiled: com.loc.df.a(com.autonavi.aps.amapapi.model.AMapLocationServer, byte[]):com.autonavi.aps.amapapi.model.AMapLocationServer");
    }
    ...
    public final AMapLocationServer a(String str) {
        ...
        try {
            ...
            if (optJSONArray.length() > 0) {
                str2 = b(optJSONArray.getJSONObject(0).optString(TableSchema.COLUMN_NAME));
            ...
            if (optJSONArray2.length() > 0) {
                aMapLocationServer.setAoiName(b(optJSONArray2.getJSONObject(0).optString(TableSchema.COLUMN_NAME)));
            }
    ...
    public final AMapLocationServer a(String str, Context context, br brVar) {
        AMapLocationServer aMapLocationServer = new AMapLocationServer("");
        aMapLocationServer.setErrorCode(7);
        StringBuffer stringBuffer = new StringBuffer();
        try {
            stringBuffer.append("#SHA1AndPackage#").append(l.e(context));
            String str2 = (String) ((List) brVar.b.get("gsid")).get(0);
            if (!TextUtils.isEmpty(str2)) {
