...
public final class cq {
    ...
    private AMapLocationServer b(AMapLocationServer aMapLocationServer) {
        if (dr.a(aMapLocationServer)) {
            if (!this.h || !dh.b(aMapLocationServer.getTime())) {
    ...
    public final AMapLocation a(AMapLocation aMapLocation) {
        ...
        long c2 = dr.c() - this.g;
        this.g = dr.c();
        if (c2 > BootloaderScanner.TIMEOUT) {
            return aMapLocation;
        }
        if (this.f == null) {
            this.f = aMapLocation;
            ...
            if (dr.a(aMapLocation, this.f) > ((((float) abs) * (this.f.getSpeed() + aMapLocation.getSpeed())) / 2000.0f) + (2.0f * (this.f.getAccuracy() + aMapLocation.getAccuracy())) + 3000.0f) {
                return this.f;
            }
            this.f = aMapLocation;
            return aMapLocation;
    ...
    public final AMapLocationServer a(AMapLocationServer aMapLocationServer) {
        if (dr.c() - this.e > 30000) {
            this.a = aMapLocationServer;
            this.e = dr.c();
            return this.a;
        }
        this.e = dr.c();
        if (!dr.a(this.a) || !dr.a(aMapLocationServer)) {
            this.b = dr.c();
            this.a = aMapLocationServer;
            return this.a;
            ...
            if (aMapLocationServer.getProvider().equals("gps")) {
                ...
                float a2 = dr.a((AMapLocation) aMapLocationServer, (AMapLocation) this.a);
