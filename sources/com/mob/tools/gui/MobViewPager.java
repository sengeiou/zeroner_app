...
public class MobViewPager extends ViewGroup {
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (this.adapter != null && this.screenCount > 0) {
            ...
            int adjustedWidthMeasureSpec = MeasureSpec.makeMeasureSpec(width, Ints.MAX_POWER_OF_TWO);
            int adjustedHeightMeasureSpec = MeasureSpec.makeMeasureSpec(height, Ints.MAX_POWER_OF_TWO);
