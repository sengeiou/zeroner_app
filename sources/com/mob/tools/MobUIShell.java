...
public class MobUIShell extends Activity {
    ...
    static {
        ...
        MobLog.getInstance().d("MobTools " + "2016-10-09".replace("-0", HelpFormatter.DEFAULT_OPT_PREFIX).replace(HelpFormatter.DEFAULT_OPT_PREFIX, Consts.DOT), new Object[0]);
        MobLog.getInstance().d("===============================", new Object[0]);
    }
    ...
    public FakeActivity getDefault() {
        try {
            ...
            if (!TextUtils.isEmpty(defaultActivity)) {
                if (defaultActivity.startsWith(Consts.DOT)) {
