...
public class SQLiteHelper {
            ...
            if (this.db == null) {
                ...
                if (shouldCreate) {
                    ...
                    for (Entry<String, String> ent : this.fieldTypes.entrySet()) {
                        ...
                        sb.append(field).append(MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR).append(type);
    ...
    public static int getSize(com.mob.tools.utils.SQLiteHelper.SingleTableDB r6) throws java.lang.Throwable {
        /*
            ...
            r1 = 0
            r0 = 0
            android.database.sqlite.SQLiteDatabase r3 = r6.db     // Catch:{ Throwable -> 0x0035 }
            java.lang.StringBuilder r4 = new java.lang.StringBuilder     // Catch:{ Throwable -> 0x0035 }
            r4.<init>()     // Catch:{ Throwable -> 0x0035 }
            java.lang.String r5 = "select count(*) from "
            java.lang.StringBuilder r4 = r4.append(r5)     // Catch:{ Throwable -> 0x0035 }
            java.lang.String r5 = r6.getName()     // Catch:{ Throwable -> 0x0035 }
            java.lang.StringBuilder r4 = r4.append(r5)     // Catch:{ Throwable -> 0x0035 }
            java.lang.String r4 = r4.toString()     // Catch:{ Throwable -> 0x0035 }
            r5 = 0
            android.database.Cursor r0 = r3.rawQuery(r4, r5)     // Catch:{ Throwable -> 0x0035 }
            boolean r3 = r0.moveToNext()     // Catch:{ Throwable -> 0x0035 }
            if (r3 == 0) goto L_0x0031
            r3 = 0
            int r1 = r0.getInt(r3)     // Catch:{ Throwable -> 0x0035 }
        L_0x0031:
            r0.close()
            return r1
        L_0x0035:
