...
public class Data {
    ...
    public static String CRC32(byte[] data) throws Throwable {
        ...
        sb.append(String.format("%02x", new Object[]{Integer.valueOf(((byte) ((int) (value >>> 56))) & UnsignedBytes.MAX_VALUE)}));
        sb.append(String.format("%02x", new Object[]{Integer.valueOf(((byte) ((int) (value >>> 48))) & UnsignedBytes.MAX_VALUE)}));
        sb.append(String.format("%02x", new Object[]{Integer.valueOf(((byte) ((int) (value >>> 40))) & UnsignedBytes.MAX_VALUE)}));
        sb.append(String.format("%02x", new Object[]{Integer.valueOf(((byte) ((int) (value >>> 32))) & UnsignedBytes.MAX_VALUE)}));
        sb.append(String.format("%02x", new Object[]{Integer.valueOf(((byte) ((int) (value >>> 24))) & UnsignedBytes.MAX_VALUE)}));
        sb.append(String.format("%02x", new Object[]{Integer.valueOf(((byte) ((int) (value >>> 16))) & UnsignedBytes.MAX_VALUE)}));
        sb.append(String.format("%02x", new Object[]{Integer.valueOf(((byte) ((int) (value >>> 8))) & UnsignedBytes.MAX_VALUE)}));
        sb.append(String.format("%02x", new Object[]{Integer.valueOf(((byte) ((int) value)) & UnsignedBytes.MAX_VALUE)}));
        while (sb.charAt(0) == '0') {
    ...
    private static String toHex(byte[] data) {
        ...
        for (byte valueOf : data) {
            buffer.append(String.format("%02x", new Object[]{Byte.valueOf(valueOf)}));
        }
        return buffer.toString();
    }
}
