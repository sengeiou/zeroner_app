...
public class MobRSA {
    ...
    private byte[] recoveryPaddingBlock(byte[] padding) throws Throwable {
        ...
        int len = ((padding[1] & UnsignedBytes.MAX_VALUE) << Ascii.CAN) + ((padding[2] & UnsignedBytes.MAX_VALUE) << 16) + ((padding[3] & UnsignedBytes.MAX_VALUE) << 8) + (padding[4] & UnsignedBytes.MAX_VALUE);
