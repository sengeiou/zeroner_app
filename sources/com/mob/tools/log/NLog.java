...
public abstract class NLog {
    ...
    public final int v(Throwable throwable, Object format, Object... args) {
        ...
        return printer.println(getSDKTag(), 2, 0, sb.append(s).append(10).append(Log.getStackTraceString(throwable)).toString());
    }
    ...
    public final int d(Throwable throwable, Object format, Object... args) {
        ...
        return printer.println(getSDKTag(), 3, 0, sb.append(s).append(10).append(Log.getStackTraceString(throwable)).toString());
    }
    ...
    public final int i(Throwable throwable, Object format, Object... args) {
        ...
        return printer.println(getSDKTag(), 4, 0, sb.append(s).append(10).append(Log.getStackTraceString(throwable)).toString());
    }
    ...
    public final int w(Throwable throwable, Object format, Object... args) {
        ...
        return printer.println(getSDKTag(), 5, 0, sb.append(s).append(10).append(Log.getStackTraceString(throwable)).toString());
    }
    ...
    public final int e(Throwable throwable, Object format, Object... args) {
        ...
        return printer.println(getSDKTag(), 6, 0, sb.append(s).append(10).append(Log.getStackTraceString(throwable)).toString());
    }
