...
public class f {
    ...
    public static synchronized long a(Context context, ArrayList<String> arrayList) throws Throwable {
        ...
        synchronized (f.class) {
            if (arrayList == null) {
                ...
                int a = b.a(context).a("table_exception", "exception_md5 in ( " + sb.toString().substring(0, sb.length() - 1) + " )", null);
    ...
    public static synchronized java.util.ArrayList<com.mob.commons.logcollector.e> a(android.content.Context r4, java.lang.String[] r5) throws java.lang.Throwable {
        /*
            ...
            int r3 = r5.length     // Catch:{ all -> 0x0027 }
            if (r3 > 0) goto L_0x000e
        L_0x000c:
            r0 = r1
            r5 = r1
        L_0x000e:
            com.mob.commons.logcollector.b r1 = com.mob.commons.logcollector.b.a(r4)     // Catch:{ all -> 0x0027 }
            java.lang.String r3 = "table_exception"
            int r1 = r1.a(r3)     // Catch:{ all -> 0x0027 }
            if (r1 <= 0) goto L_0x0021
            java.util.ArrayList r0 = a(r4, r0, r5)     // Catch:{ all -> 0x0027 }
        L_0x001f:
            monitor-exit(r2)
            return r0
        L_0x0021:
