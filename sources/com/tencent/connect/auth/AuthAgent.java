...
public class AuthAgent extends BaseApi {
    ...
    private int a(boolean z, IUiListener iUiListener) {
        ...
        if (isOEM) {
            a2.putString(Constants.PARAM_PLATFORM_ID, "desktop_m_qq-" + installChannel + HelpFormatter.DEFAULT_OPT_PREFIX + com.iwown.my_module.utility.Constants.APPSYSTEM + HelpFormatter.DEFAULT_OPT_PREFIX + registerChannel + HelpFormatter.DEFAULT_OPT_PREFIX + businessId);
        } else {
        ...
        sb.append(g.a().a(e.a(), "https://openmobile.qq.com/oauth2.0/m_authorize?"));
    ...
    public void a(IUiListener iUiListener) {
        ...
        if (!TextUtils.isEmpty(accessToken) && !TextUtils.isEmpty(openId) && !TextUtils.isEmpty(appId)) {
            str3 = j.f(str + accessToken + appId + openId + str2);
        }
    ...
    public void b(IUiListener iUiListener) {
        ...
        HttpUtils.requestAsync(this.b, e.a(), "https://openmobile.qq.com/v3/user/get_info", a2, "GET", tempRequestListener);
    }
}
