...
public abstract class BaseApi {
    ...
    public Bundle a() {
        ...
        if (isOEM) {
            bundle.putString(Constants.PARAM_PLATFORM_ID, "desktop_m_qq-" + installChannel + HelpFormatter.DEFAULT_OPT_PREFIX + Constants.APPSYSTEM + HelpFormatter.DEFAULT_OPT_PREFIX + registerChannel + HelpFormatter.DEFAULT_OPT_PREFIX + businessId);
        } else {
