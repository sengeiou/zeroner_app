    ...
    public void onDestroyView() {
        ...
        try {
            ...
            if (this.w != null) {
                ...
                View view = this.b;
                if (this.p != null) {
                    upgradeInfo = new UpgradeInfo(this.p);
                }
            ...
            try {
                if (!(this.b == null || this.p == null || this.q == null)) {
                    ...
                    if (e.E.U) {
                        ...
                        sb.append(Beta.strUpgradeDialogVersionLabel).append(": ").append(this.p.e.d).append("\n");
                        sb.append(Beta.strUpgradeDialogFileSizeLabel).append(": ");
                        float f = (float) this.p.f.d;
                        if (f >= 1048576.0f) {
                            sb.append(String.format(Locale.getDefault(), "%.1f", new Object[]{Float.valueOf(f / 1048576.0f)}));
                            sb.append("M");
                        } else if (f >= 1024.0f) {
                            sb.append(String.format(Locale.getDefault(), "%.1f", new Object[]{Float.valueOf(f / 1024.0f)}));
                            sb.append(GpsSpeedRef.KILOMETERS);
                        } else {
                            sb.append(String.format(Locale.getDefault(), "%.1f", new Object[]{Float.valueOf(f)}));
                            sb.append("B");
                        }
                        sb.append("\n");
                        sb.append(Beta.strUpgradeDialogUpdateTimeLabel).append(": ").append(new SimpleDateFormat("yyyy-MM-dd HH:mm", Locale.CHINA).format(new Date(this.p.o)));
                        this.n.setText(sb);
                    }
                    a(this.q);
                }
