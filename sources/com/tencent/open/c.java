...
import com.tencent.open.c.a.C0009a;
...
public class c extends b implements C0009a {
    static Toast c = null;
    private String d;
    ...
    private static class C0010c implements IUiListener {
        ...
        public void onComplete(Object obj) {
            ...
            com.tencent.open.b.g.a().a(this.d + "_H5", SystemClock.elapsedRealtime(), 0, 0, jSONObject.optInt("ret", -6), this.a, false);
            if (this.e != null) {
        ...
        public void onError(UiError uiError) {
            com.tencent.open.b.g.a().a(this.d + "_H5", SystemClock.elapsedRealtime(), 0, 0, uiError.errorCode, uiError.errorMessage != null ? uiError.errorMessage + this.a : this.a, false);
            if (this.e != null) {
    ...
    private class d extends Handler {
        ...
        public d(C0010c cVar, Looper looper) {
            super(looper);
            this.b = cVar;
        }
    ...
    public c(Context context, String str, String str2, IUiListener iUiListener, QQToken qQToken) {
        ...
        this.d = str2;
        this.f = new C0010c(context, str, str2, qQToken.getAppId(), iUiListener);
