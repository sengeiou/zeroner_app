...
public abstract class InstructionComparator {
    ...
    public InstructionComparator(short[] insns12, short[] insns22) {
        this.insns1 = insns12;
        this.insns2 = insns22;
        if (insns12 != null) {
            this.insnHolders1 = readInstructionsIntoHolders(new ShortArrayCodeInput(insns12), insns12.length);
        } else {
            this.insnHolders1 = null;
        }
        if (insns22 != null) {
            this.insnHolders2 = readInstructionsIntoHolders(new ShortArrayCodeInput(insns22), insns22.length);
        } else {
    ...
    public final boolean compare() {
        ...
        while (currAddress1 < this.insnHolders1.length && currAddress2 < this.insnHolders2.length) {
            ...
            if (insnHolder1.opcode != insnHolder2.opcode) {
                ...
                } else if (insnHolder1.opcode != 27 || insnHolder2.opcode != 26 || !compareString(insnHolder1.index, insnHolder2.index)) {
                    return false;
                }
    ...
    public boolean isSameInstruction(int insnAddress1, int insnAddress2) {
        ...
        switch (insnHolder1.insnFormat) {
            ...
            case 18:
            case 21:
                if (!this.visitedInsnAddrPairs.add(insnAddress1 + HelpFormatter.DEFAULT_OPT_PREFIX + insnAddress2)) {
                    return true;
                }
            ...
            case 26:
                ...
                switch (elementWidth) {
                    case 1:
                        return CompareUtils.uArrCompare((byte[]) specInsnHolder1.data, (byte[]) specInsnHolder2.data) == 0;
                    case 2:
                        return CompareUtils.uArrCompare((short[]) specInsnHolder1.data, (short[]) specInsnHolder2.data) == 0;
                    case 4:
                        return CompareUtils.uArrCompare((int[]) specInsnHolder1.data, (int[]) specInsnHolder2.data) == 0;
                    case 8:
                        return CompareUtils.sArrCompare((long[]) specInsnHolder1.data, (long[]) specInsnHolder2.data) == 0;
                    default:
                        throw new DexException("bogus element_width: " + Hex.u2(elementWidth));
                }
            case 27:
                PackedSwitchPayloadInsntructionHolder specInsnHolder12 = (PackedSwitchPayloadInsntructionHolder) insnHolder1;
                PackedSwitchPayloadInsntructionHolder specInsnHolder22 = (PackedSwitchPayloadInsntructionHolder) insnHolder2;
                ...
                int targetCount = specInsnHolder12.targets.length;
                for (int i = 0; i < targetCount; i++) {
                    if (!isSameInstruction(specInsnHolder12.targets[i], specInsnHolder22.targets[i])) {
                        return false;
                    }
                }
                return true;
            case 28:
                SparseSwitchPayloadInsntructionHolder specInsnHolder13 = (SparseSwitchPayloadInsntructionHolder) insnHolder1;
                SparseSwitchPayloadInsntructionHolder specInsnHolder23 = (SparseSwitchPayloadInsntructionHolder) insnHolder2;
                ...
                int targetCount2 = specInsnHolder13.targets.length;
                for (int i2 = 0; i2 < targetCount2; i2++) {
                    if (!isSameInstruction(specInsnHolder13.targets[i2], specInsnHolder23.targets[i2])) {
                        return false;
                    }
                }
                return true;
