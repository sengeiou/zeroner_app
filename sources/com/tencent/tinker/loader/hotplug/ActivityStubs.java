...
final class ActivityStubs {
    static final String SINGLEINSTANCE_STUB_CLASSNAME_FORMAT = (STUB_PACKAGE_NAME + Consts.DOT + ActivityStubs.class.getSimpleName() + "$SIStub_%02X");
    static final int SINGLEINSTANCE_STUB_COUNT = 10;
    static final int SINGLEINSTANCE_TRSNAPARENT_STUB_COUNT = 3;
    static final String SINGLETASK_STUB_CLASSNAME_FORMAT = (STUB_PACKAGE_NAME + Consts.DOT + ActivityStubs.class.getSimpleName() + "$SGTKStub_%02X");
    static final int SINGLETASK_STUB_COUNT = 10;
    static final int SINGLETASK_TRSNAPARENT_STUB_COUNT = 3;
    static final String SINGLETOP_STUB_CLASSNAME_FORMAT = (STUB_PACKAGE_NAME + Consts.DOT + ActivityStubs.class.getSimpleName() + "$SGTStub_%02X");
    ...
    static final String STARDARD_STUB_CLASSNAME_FORMAT = (STUB_PACKAGE_NAME + Consts.DOT + ActivityStubs.class.getSimpleName() + "$STDStub_%02X");
