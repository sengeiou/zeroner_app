...
public final class HisEcgData {
    ...
    /* access modifiers changed from: private */
    public static Descriptor internal_static_HisDataECG_descriptor = ((Descriptor) getDescriptor().getMessageTypes().get(0));
    /* access modifiers changed from: private */
    public static FieldAccessorTable internal_static_HisDataECG_fieldAccessorTable = new FieldAccessorTable(internal_static_HisDataECG_descriptor, new String[]{"TimeStamp", "RawData"});

    public static final class HisDataECG extends GeneratedMessageV3 implements HisDataECGOrBuilder {
        private static final HisDataECG DEFAULT_INSTANCE = new HisDataECG();
        @Deprecated
        public static final Parser<HisDataECG> PARSER = new AbstractParser<HisDataECG>() {
            public HisDataECG parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
        ...
        public static final class Builder extends com.google.protobuf.GeneratedMessageV3.Builder<Builder> implements HisDataECGOrBuilder {
            ...
            public FieldAccessorTable internalGetFieldAccessorTable() {
                return HisEcgData.internal_static_HisDataECG_fieldAccessorTable.ensureFieldAccessorsInitialized(HisDataECG.class, Builder.class);
            }
            ...
            private void maybeForceBuilderInitialization() {
                if (HisDataECG.alwaysUseFieldBuilders) {
            ...
            public HisDataECG buildPartial() {
                HisDataECG result = new HisDataECG((com.google.protobuf.GeneratedMessageV3.Builder) this);
                int to_bitField0_ = 0;
            ...
            public Builder mergeFrom(HisDataECG other) {
                if (other != HisDataECG.getDefaultInstance()) {
            ...
            public Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
                ...
                try {
                    HisDataECG parsedMessage2 = (HisDataECG) HisDataECG.PARSER.parsePartialFrom(input, extensionRegistry);
                    if (parsedMessage2 != null) {
                        mergeFrom(parsedMessage2);
                    }
                    return this;
                } catch (InvalidProtocolBufferException e) {
                    HisDataECG parsedMessage3 = (HisDataECG) e.getUnfinishedMessage();
        ...
        private HisDataECG(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            this();
        ...
        public static HisDataECG parseFrom(ByteString data) throws InvalidProtocolBufferException {
            return (HisDataECG) PARSER.parseFrom(data);
        }

        public static HisDataECG parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return (HisDataECG) PARSER.parseFrom(data, extensionRegistry);
        }

        public static HisDataECG parseFrom(byte[] data) throws InvalidProtocolBufferException {
            return (HisDataECG) PARSER.parseFrom(data);
        }

        public static HisDataECG parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return (HisDataECG) PARSER.parseFrom(data, extensionRegistry);
        }

        public static HisDataECG parseFrom(InputStream input) throws IOException {
            return (HisDataECG) GeneratedMessageV3.parseWithIOException(PARSER, input);
        }

        public static HisDataECG parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            return (HisDataECG) GeneratedMessageV3.parseWithIOException(PARSER, input, extensionRegistry);
        }

        public static HisDataECG parseDelimitedFrom(InputStream input) throws IOException {
            return (HisDataECG) GeneratedMessageV3.parseDelimitedWithIOException(PARSER, input);
        }

        public static HisDataECG parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            return (HisDataECG) GeneratedMessageV3.parseDelimitedWithIOException(PARSER, input, extensionRegistry);
        }

        public static HisDataECG parseFrom(CodedInputStream input) throws IOException {
            return (HisDataECG) GeneratedMessageV3.parseWithIOException(PARSER, input);
        }

        public static HisDataECG parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            return (HisDataECG) GeneratedMessageV3.parseWithIOException(PARSER, input, extensionRegistry);
        }
        ...
        public static Parser<HisDataECG> parser() {
            return PARSER;
        }

        public Parser<HisDataECG> getParserForType() {
            return PARSER;
        }
    ...
    public interface HisDataECGOrBuilder extends MessageOrBuilder {
