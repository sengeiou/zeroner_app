...
public class ShSwitchView extends View {
    ...
    private static final int foregroundColor = -4868163;
    ...
    public ShSwitchView(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.isChange = true;
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.device_module_ShSwitchView);
        this.tintColor = ta.getColor(R.styleable.device_module_ShSwitchView_device_module_tintColor, 1145599);
        ...
        this.outerStrokeWidth = ta.getDimensionPixelOffset(R.styleable.device_module_ShSwitchView_device_module_outerStrokeWidth, (int) TypedValue.applyDimension(1, 1.5f, context.getResources().getDisplayMetrics()));
        this.shadowSpace = ta.getDimensionPixelOffset(R.styleable.device_module_ShSwitchView_device_module_shadowSpace, defaultShadowSpace);
        ta.recycle();
    ...
    public void setEnabled(boolean enabled) {
        ...
        if (enabled) {
            ...
            this.tintColor = RGBColorTransform(0.5f, this.tempTintColor, foregroundColor);
        }
    }
    ...
    public void onDraw(Canvas canvas) {
        ...
        drawRoundRect(this.knobBound.left, ((float) (this.shadowSpace / 2)) + this.knobBound.top, this.knobBound.right, ((float) (this.shadowSpace / 2)) + this.knobBound.bottom, this.cornerRadius - ((float) this.outerStrokeWidth), canvas, this.paint);
        this.paint.setColor(foregroundColor);
