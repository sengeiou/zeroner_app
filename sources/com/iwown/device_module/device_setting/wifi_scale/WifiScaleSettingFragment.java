...
public class WifiScaleSettingFragment extends SupportFragment implements OnClickListener, View {
    TipDialog alert;
    ...
    public static WifiScaleSettingFragment newInstance() {
        Bundle args = new Bundle();
        WifiScaleSettingFragment fragment = new WifiScaleSettingFragment();
    ...
    public void onClick(android.view.View v) {
        ...
        if (id == R.id.to_unarchived_data_setting) {
            ...
            this.pvCustomOptions = new Builder(this._mActivity, new OnOptionsSelectListener() {
                public void onOptionsSelect(int options1, int option2, int options3, android.view.View v) {
                    ...
                    if (options1 == 0) {
                        ...
                        unit = WifiScaleSettingFragment.this.changeUnit;
                    } else if (options1 == 2) {
                        unit = 3;
                    }
                    WifiScaleSetting setting = WifiScaleSettingFragment.this.presenter.wifiScaleSettingStatue();
                    setting.setUnitSwitch(unit);
                    WifiScaleSettingFragment.this.presenter.saveWifiScaleStatue(setting);
                ...
                public void customLayout(android.view.View v) {
                    ...
                    ((TextView) v.findViewById(R.id.dialog_title_option)).setText(WifiScaleSettingFragment.this.getString(R.string.device_module_scale_wifi_setting_5));
                    TextView ivCancel = (TextView) v.findViewById(R.id.cancel_dialog_option);
                    tvSubmit.setOnClickListener(new OnClickListener() {
                        public void onClick(android.view.View v) {
                            WifiScaleSettingFragment.this.pvCustomOptions.returnData();
                            WifiScaleSettingFragment.this.pvCustomOptions.dismiss();
                        }
                    });
                ...
                public void onOk() {
                    ...
                    NetFactory.getInstance().getClient(new MyCallback<Integer>() {
                        public void onSuccess(Integer integer) {
                            WifiScaleSettingFragment.this.alert.dismiss();
            ...
            if (id == R.id.wifi_scale_name) {
            }
        }
    }

    private void initData() {
        this.scaleMacMy.setText(S2WifiUtils.wifiScaleMac(ContextUtil.getUID()));
        this.items.clear();
        ...
        NetFactory.getInstance().getClient(new MyCallback() {
            public void onSuccess(Object o) {
                WifiScaleSettingFragment.this.toUserList.setMessageText(String.valueOf(WifiScaleData.getInstance().userCount()));
            }

            public void onFail(Throwable e) {
                WifiScaleSettingFragment.this.toUserList.setMessageText(String.valueOf(users));
            }
        }).getNoAccountList();
    }
