...
public class LSubSettingItem extends RelativeLayout {
    ...
    public OnLSubSettingItemClick mOnLSettingItemClick;
    ...
    public interface OnLSubSettingItemClick {
        void click(int i, boolean z);
    }

    public LSubSettingItem(Context context) {
        this(context, null);
    }

    public LSubSettingItem(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public LSubSettingItem(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mRootLayout.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                LSubSettingItem.this.clickOn(v.getId());
            }
        });
        this.mRightIcon_check.setOnCheckedChangeListener(new OnCheckedChangeListener() {
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (LSubSettingItem.this.mOnLSettingItemClick != null) {
                    LSubSettingItem.this.mOnLSettingItemClick.click(buttonView.getId(), isChecked);
                }
            }
        });
    ...
    public void setmOnLSettingItemClick(OnLSubSettingItemClick mOnLSettingItemClick2) {
    ...
    public void getCustomStyle(Context context, AttributeSet attrs) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            } else if (attr == R.styleable.device_module_LSettingView_device_module_leftSubText) {
                this.mTvLeftSubText.setText(a.getString(attr));
            } else if (attr == R.styleable.device_module_LSettingView_device_module_LSubtextSize) {
                this.mTvLeftSubText.setTextSize(a.getFloat(attr, 12.0f));
            } else if (attr == R.styleable.device_module_LSettingView_device_module_LSubtextColor) {
                this.mTvLeftSubText.setTextColor(a.getColor(attr, -3355444));
            }
        }
        a.recycle();
    }
    ...
    private void initView(Context context) {
        this.mView = View.inflate(context, R.layout.device_module_sub_settingitem, this);
        ...
        this.mTvLeftSubText = (TextView) this.mView.findViewById(R.id.tv_leftsubtext);
    }
