...
public final class Base64Utility {
    ...
    private static final char DEPAD = '=';
    ...
    private static boolean isdePad(char octect) {
        return octect == '=';
    }
    ...
    public static String encode(byte[] binaryData) {
        ...
        while (i2 < numberTriplets) {
            ...
            byte k = (byte) (b1 & 3);
            byte val1 = (b1 & Byte.MIN_VALUE) == 0 ? (byte) (b1 >> 2) : (byte) ((b1 >> 2) ^ Opcodes.AND_LONG_2ADDR);
            byte val2 = (b2 & Byte.MIN_VALUE) == 0 ? (byte) (b2 >> 4) : (byte) ((b2 >> 4) ^ 240);
            if ((b3 & Byte.MIN_VALUE) == 0) {
                i = b3 >> 6;
            } else {
                i = (b3 >> 6) ^ TinkerReport.KEY_LOADED_EXCEPTION_DEX;
            }
            byte val3 = (byte) i;
        ...
        if (fewerThan24bits == 8) {
            ...
            encodedData[encodedIndex] = lookUpBase64Alphabet[(b12 & Byte.MIN_VALUE) == 0 ? (byte) (b12 >> 2) : (byte) ((b12 >> 2) ^ Opcodes.AND_LONG_2ADDR)];
            ...
            if (fewerThan24bits == 16) {
                ...
                byte k3 = (byte) (b13 & 3);
                byte val12 = (b13 & Byte.MIN_VALUE) == 0 ? (byte) (b13 >> 2) : (byte) ((b13 >> 2) ^ Opcodes.AND_LONG_2ADDR);
    ...
    public static byte[] decode(java.lang.String r25) {
        ...
        L_0x00e5:
            boolean r22 = isdePad(r11)
            if (r22 == 0) goto L_0x00f1
            boolean r22 = isdePad(r12)
        ...
        L_0x0194:
            ...
            goto L_0x0004
        */
        throw new UnsupportedOperationException("Method not decompiled: com.iwown.my_module.utility.Base64Utility.decode(java.lang.String):byte[]");
    }
