...
public class WheelViewPro extends TosGallery {
    ...
    private void initialize(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.gallery_bg_drawble);
        this.mSelectorDrawable = getContext().getResources().getDrawable(a.getResourceId(R.styleable.gallery_bg_drawble_selectedBackground, -1));
        a.recycle();
