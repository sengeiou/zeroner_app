...
import com.iwown.sport_module.net.constant.ConstantsDev.APP_INFO;
import com.iwown.sport_module.net.constant.ConstantsLive.ChinaBaseUrl;
...
public class ChinaClient extends BaseClient {
    ...
    public ChinaClient(MyCallback callback) {
        this.mCallback = callback;
    }
    ...
    public OverseasApiService getApiService(String urlType) {
        if ("user".equals(urlType)) {
            ...
            if (this.sportApiService == null) {
                ...
                this.sportApiService = (OverseasApiService) new Builder().baseUrl(ChinaBaseUrl.NEW_API_1 + "sportservice/").addConverterFactory(GsonConverterFactory.create()).addCallAdapterFactory(RxJava2CallAdapterFactory.create()).client(new OkHttpClient.Builder().connectTimeout(30, TimeUnit.SECONDS).readTimeout(30, TimeUnit.SECONDS).addInterceptor(httpLogUtils2).build()).build().create(OverseasApiService.class);
            }
            ...
            if (this.devApiService == null) {
                ...
                this.devApiService = (OverseasApiService) new Builder().baseUrl(ChinaBaseUrl.NEW_API_3 + "deviceservice/").addConverterFactory(GsonConverterFactory.create()).addCallAdapterFactory(RxJava2CallAdapterFactory.create()).client(new OkHttpClient.Builder().connectTimeout(30, TimeUnit.SECONDS).addInterceptor(httpLogUtils4).build()).build().create(OverseasApiService.class);
            }
            ...
            if (this.weightDeviceService == null) {
                ...
                this.weightDeviceService = (OverseasApiService) new Builder().baseUrl(ChinaBaseUrl.NEW_API_3 + "deviceservice/").addConverterFactory(GsonConverterFactory.create()).addCallAdapterFactory(RxJava2CallAdapterFactory.create()).client(new OkHttpClient.Builder().connectTimeout(30, TimeUnit.SECONDS).addInterceptor(httpLogUtils5).build()).build().create(OverseasApiService.class);
            }
            ...
            if (this.otherService == null) {
                ...
                this.otherService = (OverseasApiService) new Builder().baseUrl(ChinaBaseUrl.NEW_API_1).addConverterFactory(GsonConverterFactory.create()).addCallAdapterFactory(RxJava2CallAdapterFactory.create()).client(new OkHttpClient.Builder().readTimeout(90, TimeUnit.SECONDS).connectTimeout(30, TimeUnit.SECONDS).addInterceptor(httpLogUtils11).build()).build().create(OverseasApiService.class);
            }
    ...
    public void getCity(String lat, String lng, String language) {
        ...
        GaoDeMapHelper.getInstance().getOnceLocation(new MyCallback<Location>() {
    ...
    public void getWeather(RequestBody body) {
        getApiService("weather").getWeather(body).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread()).subscribe((Observer<? super T>) new OverseasCallWrapper<ResponseBody>() {
            ...
            public void onSuccess(ResponseBody body) throws Exception {
                KLog.e("licl", "天气请求成功-->");
                if (ChinaClient.this.mCallback != null) {
                    ChinaClient.this.mCallback.onSuccess(body);
                }
            }
            ...
            public void onError(Throwable e) {
                super.onError(e);
                if (ChinaClient.this.mCallback != null) {
                    ChinaClient.this.mCallback.onFail(e);
                }
            }
        });
    }
        ...
        for (int i = 0; i < 3; i++) {
            getApiService(DownType.SPORT).sportDownRepo(uid, 10, dateUtil.getSyyyyMMddDate()).observeOn(Schedulers.io()).map(new Function<SportDownCode, SportDownCode>() {
                ...
                public void onSuccess(SportDownCode code) throws Exception {
                    KLog.e("下载28成功-->");
                    if (ChinaClient.this.mCallback != null) {
                        ChinaClient.this.mCallback.onSuccess(code);
                    }
                }
    ...
    public void up28Data(long uid, List<SportData> sportData) {
        getApiService(DownType.SPORT).sportUpRepoChina(uid, sportData).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread()).subscribe((Observer<? super T>) new OverseasCallWrapper<RetCode>() {
            /* access modifiers changed from: protected */
    ...
    public void up29Data(long uid, List<WalkData> walkData) {
        List<WalkHealthyData> walkHealthyData = new ArrayList<>();
        if (walkData != null) {
            for (WalkData walkDatum : walkData) {
                WalkHealthyData walkHealthyData1 = new WalkHealthyData();
                walkHealthyData1.setUid(walkDatum.getUid());
                walkHealthyData1.setCalorie(walkDatum.getCalorie());
                walkHealthyData1.setData_from(walkDatum.getData_from());
                walkHealthyData1.setRecord_date(walkDatum.getRecord_date());
                walkHealthyData1.setSteps(walkDatum.getStep());
                walkHealthyData1.setWalk_distance(walkDatum.getDistance());
                walkHealthyData1.setRun_distance(0.0f);
                walkHealthyData.add(walkHealthyData1);
            }
        }
        getApiService(DownType.SPORT).walkUpHealthyRepo(uid, walkHealthyData).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread()).subscribe((Observer<? super T>) new OverseasCallWrapper<RetCode>() {
            /* access modifiers changed from: protected */
            public void onSuccess(RetCode code) throws Exception {
                if (ChinaClient.this.mCallback != null) {
                    ChinaClient.this.mCallback.onSuccess(code);
    ...
    public void get62FileDown(long uid, String data_from, String recordDate, final String save_dir_path, final String file_name) {
        ...
        getApiService("log_up").get62FileUrl(uid, recordDate, data_from).subscribeOn(Schedulers.io()).observeOn(Schedulers.io()).subscribe((Observer<? super T>) new OverseasCallWrapper<UpSDFileCode>() {
            ...
            public void onSuccess(UpSDFileCode code) throws Exception {
                KLog.i("获取62文件的下载链接成功-->" + code.getUrl());
                ChinaClient.this.downAndSaveFile(code.getUrl(), save_dir_path, file_name);
            }
    ...
    public void get61FileDown(long uid, String data_from, String recordDate, final String save_dir_path, final String file_name) {
        ...
        getApiService("log_up").get61FileUrl(uid, recordDate, data_from).subscribeOn(Schedulers.io()).observeOn(Schedulers.io()).subscribe((Observer<? super T>) new OverseasCallWrapper<UpSDFileCode>() {
            /* access modifiers changed from: protected */
            public void onSuccess(UpSDFileCode code) throws Exception {
                KLog.i("获取61文件的下载链接成功-->" + code.getUrl());
                ChinaClient.this.downAndSaveFile(code.getUrl(), save_dir_path, file_name);
            }
    ...
    public void upPhoneGpsFileAndUpGpsDetailData(long uid, File file, long time) {
        ...
        getApiService("fileservice").upPhoneGpsFile(uid, RequestBody.create(MediaType.parse("multipart/form-data"), file)).subscribeOn(Schedulers.io()).doOnNext(new Consumer<GpsRetCode>() {
            ...
            public Observable<RetCode> apply(GpsRetCode code) throws Exception {
                ...
                totals.add(total);
                return ChinaClient.this.getApiService(DownType.SPORT).upGpsDetailRepo(j, totals);
            }
    ...
    public void getAdvertise(String lat, String lng) {
        getApiService("location").getCity(lat + "," + lng, "zh-CN", true, AppConfigUtil.GoogleMapKey).subscribeOn(Schedulers.io()).observeOn(Schedulers.io()).flatMap(new Function<ResponseBody, ObservableSource<CheckAdCode>>() {
                    ...
                    for (int i = 0; i < ja.length(); i++) {
                        ...
                        for (int j = 0; j < ja2.length(); j++) {
                            ...
                            if ("country".equals(jb3.getJSONArray("types").getString(0))) {
                                ...
                                return ChinaClient.this.getApiService("wawaservice").checkAdRepo(jb3.getString("short_name"));
                            }
                        }
                        if (0 != 0) {
                            break;
            ...
            public void accept(Boolean aBoolean) throws Exception {
                ...
                if (ChinaClient.this.mCallback != null) {
                    ChinaClient.this.mCallback.onSuccess(aBoolean);
                }
            }
        ...
        if (sleepUpNewSend.getContent() != null && sleepUpNewSend.getContent().size() != 0) {
            getApiService(DownType.SPORT).sleepUpRepo(sleepUpNewSend.getUid(), sleepUpNewSend.getContent()).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread()).subscribe((Observer<? super T>) new OverseasCallWrapper<RetCode>() {
                ...
                public void onSuccess(RetCode retCode) throws Exception {
                    ...
                    } else if (ChinaClient.this.mCallback != null) {
        ...
        getApiService("weight_sport").getWifiScaleRWData(uid, weightDate, scaleid).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread()).subscribe((Observer<? super T>) new OverseasCallWrapper<WifiScaleRWResp>() {
            ...
            public void onSuccess(WifiScaleRWResp wifiScaleRWResp) throws Exception {
                ...
                if (wifiScaleRWResp.getRetCode() != 0 || wifiScaleRWResp.getData() == null) {
                    ChinaClient.this.mCallback.onSuccess(Integer.valueOf(0));
                    return;
                }
    ...
    public void heartDownRepo(long uid, int ds, String st, DateUtil dateUtil) {
        ...
        getApiService(DownType.SPORT).heartDownHealthyRepo(uid, ds, st).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread()).subscribe((Observer<? super T>) new OverseasCallWrapper<HeartDownCode>() {
            /* access modifiers changed from: protected */
            public void onSuccess(HeartDownCode heartDownCode) throws Exception {
                ...
                Iterator<HeartDownData1> iterator = content.iterator();
                while (iterator.hasNext()) {
                    HeartDownData1 heartDownData1 = (HeartDownData1) iterator.next();
                    if (DateUtil.isSameDay(new Date(), new Date(heartDownData1.getEnd_time() * 1000))) {
    ...
    public void uploadHeartSportData(final HeartUpSend unUploadHeartSportsDatas) {
        ...
        if (unUploadHeartSportsDatas.getContent() != null && unUploadHeartSportsDatas.getContent().size() != 0) {
            getApiService(DownType.SPORT).heartUpHealthyRepo(unUploadHeartSportsDatas.getUid(), unUploadHeartSportsDatas.getContent()).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread()).subscribe((Observer<? super T>) new OverseasCallWrapper<RetCode>() {
                /* access modifiers changed from: protected */
                public void onSuccess(RetCode retCode) throws Exception {
                    if (ChinaClient.this.mCallback != null) {
                        ChinaClient.this.mCallback.onSuccess(Integer.valueOf(retCode.getRetCode()));
    ...
    public void getSupportsByName() {
        ...
        getApiService("device").getSupportsByName().subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread()).subscribe((Observer<? super T>) new OverseasCallWrapper<DevSupportByNameCode>() {
            ...
            public void onSuccess(DevSupportByNameCode code) throws Exception {
                ...
                if (ChinaClient.this.mCallback != null) {
                    ChinaClient.this.mCallback.onSuccess(Integer.valueOf(code.getRetCode()));
                }
            }
    ...
    private OverseasApiService getNggsApi() {
        HttpLogUtils httpLogUtils = new HttpLogUtils();
        httpLogUtils.setLevel(Level.CUSTOM);
        return (OverseasApiService) new Builder().baseUrl(ChinaBaseUrl.NGG_Url).addConverterFactory(GsonConverterFactory.create()).addCallAdapterFactory(RxJava2CallAdapterFactory.create()).client(new OkHttpClient.Builder().readTimeout(15, TimeUnit.SECONDS).connectTimeout(10, TimeUnit.SECONDS).addInterceptor(httpLogUtils).build()).build().create(OverseasApiService.class);
    }
    ...
    public void downloadPageSportGps(long uid, int sportType, String startTime, int size) {
        getNggsApi().downloadPageSportGps(uid, sportType, startTime, size).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread()).subscribe((Observer<? super T>) new OverseasCallWrapper<SportGpsCode>() {
            /* access modifiers changed from: protected */
            public void onSuccess(SportGpsCode retCode) throws Exception {
                ...
                } else if (retCode.getData() == null) {
                    ChinaClient.this.mCallback.onSuccess(Integer.valueOf(0));
                } else {
                    ChinaClient.this.mCallback.onSuccess(Integer.valueOf(retCode.getData().size()));
                }
            }
    ...
    public void downloadPageSportBall(long uid, String startTime, int size) {
        getNggsApi().downloadPageSportBall(uid, startTime, size).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread()).subscribe((Observer<? super T>) new OverseasCallWrapper<SportBallCode>() {
            /* access modifiers changed from: protected */
    ...
    public void downloadPageSportOther(long uid, String startTime, int size) {
        getNggsApi().downloadPageSportOther(uid, startTime, size).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread()).subscribe((Observer<? super T>) new OverseasCallWrapper<SportOtherCode>() {
            /* access modifiers changed from: protected */
    ...
    public void downloadPageSportSwim(long uid, String startTime, int size) {
        getNggsApi().downloadPageSportSwim(uid, startTime, size).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread()).subscribe((Observer<? super T>) new OverseasCallWrapper<SportSwimCode>() {
            /* access modifiers changed from: protected */
    ...
    public void uploadSport28(Sport28Send sport28Send) {
        getNggsApi().uploadSport28(sport28Send).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread()).subscribe((Observer<? super T>) new OverseasCallWrapper<ReturnCode>() {
            /* access modifiers changed from: protected */
    ...
    public void downloadSport28(long uid, DateUtil dateUtil) {
        ...
        for (int i = 0; i < 3 && dateUtil.getZeroTime() <= dateToday.getUnixTimestamp(); i++) {
            ...
            getNggsApi().downloadSport28(uid, st1, ed1).observeOn(Schedulers.io()).map(new Function<Sport28Code, Sport28Code>() {
    ...
    public void downloadAllSportGps(long uid) {
        getNggsApi().downloadAllSportGps(uid).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread()).subscribe((Observer<? super T>) new OverseasCallWrapper<AllSportGpsCode>() {
            /* access modifiers changed from: protected */
    ...
    public void downloadAllSportBall(long uid) {
        getNggsApi().downloadAllSportBall(uid).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread()).subscribe((Observer<? super T>) new OverseasCallWrapper<AllSportBallCode>() {
            /* access modifiers changed from: protected */
    ...
    public void downloadAllSportOther(long uid) {
        getNggsApi().downloadAllSportOther(uid).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread()).subscribe((Observer<? super T>) new OverseasCallWrapper<AllSportOtherCode>() {
            /* access modifiers changed from: protected */
    ...
    public void downloadAllSportSwim(long uid) {
        getNggsApi().downloadAllSportSwim(uid).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread()).subscribe((Observer<? super T>) new OverseasCallWrapper<AllSportSwimCode>() {
            /* access modifiers changed from: protected */
    ...
    public void uploadR1Data(long uid, String st, String et, String data_from, File file) {
        getNggsApi().r1DataRepo(uid, st, et, data_from, Part.createFormData("file", file.getName(), RequestBody.create(MediaType.parse("multipart/form-data"), file))).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread()).subscribe((Observer<? super T>) new OverseasCallWrapper<RetCode>() {
            /* access modifiers changed from: protected */
            public void onSuccess(RetCode retCode) throws Exception {
                if (ChinaClient.this.mCallback != null) {
                    ChinaClient.this.mCallback.onSuccess(retCode);
    ...
    public void hasSport28DataNet(long uid, int year, int month) {
        ...
        final int i = year;
        final int i2 = month;
        getNggsApi().downSport28HasData(uid, year, month).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread()).subscribe((Observer<? super T>) new OverseasCallWrapper<Sport28MonthCode>() {
            /* access modifiers changed from: protected */
    ...
    public void uploadEcgSportData(List<EcgUploadNet> data) {
        ...
        if (data != null && data.size() > 0) {
            ...
            list.setData(data);
            getNggsApi().upLoadEcgData(list).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread()).subscribe((Observer<? super T>) new OverseasCallWrapper<RetCode>() {
                /* access modifiers changed from: protected */
                public void onSuccess(RetCode retCode) throws Exception {
                    if (ChinaClient.this.mCallback != null) {
                        ChinaClient.this.mCallback.onSuccess(Integer.valueOf(retCode.getRetCode()));
    ...
    public void updateEcgNote(EcgDataNoteNet net) {
        ...
        getNggsApi().upDateEcgNote(net).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread()).subscribe((Observer<? super T>) new OverseasCallWrapper<RetCode>() {
            /* access modifiers changed from: protected */
            public void onSuccess(RetCode retCode) throws Exception {
                if (ChinaClient.this.mCallback != null) {
                    ChinaClient.this.mCallback.onSuccess(Integer.valueOf(retCode.getRetCode()));
    ...
    public void updateEcgAiResult(EcgDataAiResult result) {
        ...
        getNggsApi().upDateEcgAi(result).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread()).subscribe((Observer<? super T>) new OverseasCallWrapper<ReturnCode>() {
            /* access modifiers changed from: protected */
            public void onSuccess(ReturnCode retCode) throws Exception {
                if (ChinaClient.this.mCallback != null) {
                    ChinaClient.this.mCallback.onSuccess(Integer.valueOf(retCode.getReturnCode()));
                }
            }
    ...
    public void downLoadEcgData(final long uid, String year, String month, String day) {
        ...
        getNggsApi().downEcgData(uid, year, month, day).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread()).subscribe((Observer<? super T>) new OverseasCallWrapper<EcgDownList>() {
            /* access modifiers changed from: protected */
            public void onSuccess(EcgDownList ecgDownList) throws Exception {
                if (ChinaClient.this.mCallback != null) {
                    ChinaClient.this.mCallback.onSuccess(Integer.valueOf(ecgDownList.getReturnCode()));
                }
                if (ecgDownList != null && ecgDownList.getReturnCode() == 0 && ecgDownList.getData() != null && ecgDownList.getData().size() > 0) {
                    for (int i = 0; i < ecgDownList.getData().size(); i++) {
                        try {
                            ...
                            ChinaClient.this.downLoadEcgFile(eln.getUrl(), uid, eln.getData_from(), eln.getStart_time(), bean);
    ...
    public void hasEcgDataNet(final long uid, String year, String month) {
        ...
        getNggsApi().downEcgHasData(uid, year, month).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread()).subscribe((Observer<? super T>) new OverseasCallWrapper<EcgHasDataNet>() {
            /* access modifiers changed from: protected */
                ...
                if (ecgHasDataNet != null && ecgHasDataNet.getData().size() > 0) {
                    for (int i = 0; i < ecgHasDataNet.getData().size(); i++) {
                        ...
                        if (ModuleRouterEcgService.getInstance().checkHasDataByUid(uid, d1) <= 0) {
                            KLog.i("-----没有数据去下载数据------");
                            ChinaClient.this.downLoadEcgData(uid, d1.getYear() + "", d1.getMonth() + "", d1.getDay() + "");
                        }
                    }
                }
            }
        ...
        getApiService("others").downloadFile(url, "identity").subscribeOn(Schedulers.io()).observeOn(Schedulers.io()).map(new Function<ResponseBody, ResponseBody>() {
            ...
            public void onSuccess(ResponseBody responseBody) throws Exception {
                ...
                if (file.exists()) {
                    ...
                    ChinaClient.this.readFileContent(j, str2, str3, path);
                    return;
                }
                ...
                if (zipFile.exists()) {
                    ...
                    ChinaClient.this.readFileContent(j, str2, str3, zipPath);
                }
            }
    ...
    public void downloadAllBlood(long uid, String st, String et) {
        ...
        getNggsApi().downloadBlood(uid, st, et).enqueue(new Callback<BpDownData1>() {
            public void onResponse(Call<BpDownData1> call, Response<BpDownData1> response) {
                try {
                    ...
                    if (ChinaClient.this.mCallback != null) {
                        ...
                        ChinaClient.this.mCallback.onSuccess(bpDownData1);
                    }
                } catch (Exception e2) {
                }
            }
    ...
    public void downloadBPcoverage(long uid, int year, int mouth) {
        ...
        getNggsApi().downloadBPcoverage(uid, year, mouth).enqueue(new Callback<bpCoverageDown>() {
            public void onResponse(Call<bpCoverageDown> call, Response<bpCoverageDown> response) {
                try {
                    if (response.body() != null && ((bpCoverageDown) response.body()).getReturnCode() == 0 && ChinaClient.this.mCallback != null) {
                        ChinaClient.this.mCallback.onSuccess(response.body());
                    }
                } catch (Exception e) {
                }
            }
    ...
    public void uploadBlooddata(BloodDataUpload bloodDataUpload) {
        ...
        getNggsApi().uploadBlood(bloodDataUpload).enqueue(new Callback<ResponseBody>() {
