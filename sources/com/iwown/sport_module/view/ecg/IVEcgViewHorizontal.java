...
public class IVEcgViewHorizontal extends View {
    Context context;
    protected int mBackgroundColor = Color.parseColor("#00ffffff");
    protected int mGridColor = Color.parseColor("#FFC4C4");
    protected int mGridWidth = 100;
    protected int mHeight;
    protected Paint mPaint;
    protected Paint mPath;
    protected int mSGridColor = Color.parseColor("#FFD3D3");
    protected int mSGridWidth = 20;
    protected int mWidth;

    public IVEcgViewHorizontal(Context context2) {
        super(context2);
        this.context = context2;
    }

    public IVEcgViewHorizontal(Context context2, @Nullable AttributeSet attrs) {
        super(context2, attrs);
        this.context = context2;
    }

    public IVEcgViewHorizontal(Context context2, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context2, attrs, defStyleAttr);
        this.context = context2;
    }

    @TargetApi(21)
    public IVEcgViewHorizontal(Context context2, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
