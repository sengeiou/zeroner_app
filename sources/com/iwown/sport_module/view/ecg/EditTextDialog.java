...
public class EditTextDialog extends NewAbsCustomDialog implements OnClickListener {
    ...
    public void initView() {
        ...
        this.mNameEdt.setFilters(new InputFilter[]{new EmojiFilter(), new LengthFilter(520)});
    ...
    public void setEditHint(String mTextString2) {
        this.mNameEdt.setText(mTextString2);
    }
    ...
    public int getLayoutResID() {
        return R.layout.sport_module_view_edittext_dialog;
    }
