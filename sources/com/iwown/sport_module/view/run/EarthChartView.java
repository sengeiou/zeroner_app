...
public class EarthChartView extends View {
    ...
    public EarthChartView(Context context) {
        this(context, null);
    }

    public EarthChartView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public EarthChartView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void setDatas(final List<DlineDataBean> datas2, boolean b) {
        ...
        postDelayed(new Runnable() {
            public void run() {
                EarthChartView.this.datas = datas2;
                EarthChartView.this.invalidate();
            }
        }, 200);
    }
    ...
    public void setCanTouch(boolean canTouch2) {
        this.canTouch = canTouch2;
    }
