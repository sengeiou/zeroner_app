...
public class HRMonitorDialog extends NewAbsCustomDialog implements OnClickListener {
    ...
    public HRMonitorDialog(Context context, boolean isCancel2) {
        super(context);
    ...
    public void initView() {
        ...
        ClickableSpan clickableSpan = new ClickableSpan() {
            ...
            public void updateDrawState(TextPaint ds2) {
                this.ds = ds2;
                HRMonitorDialog.this.content.setHighlightColor(HRMonitorDialog.this.mContext.getResources().getColor(17170445));
