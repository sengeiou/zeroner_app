...
public class DividerGridItemDecoration extends ItemDecoration {
    ...
    public void drawHorizontal(Canvas c, RecyclerView parent) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            this.mDivider.setBounds(child.getLeft() - params.leftMargin, top, child.getRight() + params.rightMargin + this.lineWidth, top + this.lineWidth);
    ...
    public void getItemOffsets(Rect outRect, int itemPosition, RecyclerView parent) {
        ...
        if (isLastRaw(parent, itemPosition, spanCount, childCount)) {
            outRect.set(0, 0, this.lineWidth, 0);
        } else if (isLastColum(parent, itemPosition, spanCount, childCount)) {
            outRect.set(0, 0, 0, this.lineWidth);
        } else {
            outRect.set(0, 0, this.lineWidth, this.lineWidth);
        }
    }
}
