...
public class TB_sport_all_swim extends DataSupport {
    private float calorie;
    private float calorie_net;
    private float distance;
    private float distance_net;
    private int down;
    ...
    public float getDistance_net() {
        return this.distance_net;
    }

    public void setDistance_net(float distance_net2) {
        this.distance_net = distance_net2;
    }
}
