...
public class TB_sport_all_gps extends DataSupport {
    ...
    public int getRun_down() {
        return this.run_down;
    }

    public void setRun_down(int run_down2) {
        this.run_down = run_down2;
    }

    public int getCycle_down() {
        return this.cycle_down;
    }

    public void setCycle_down(int cycle_down2) {
        this.cycle_down = cycle_down2;
    }

    public int getWalk_down() {
        return this.walk_down;
    }

    public void setWalk_down(int walk_down2) {
        this.walk_down = walk_down2;
    }

    public int getClimb_down() {
        return this.climb_down;
    }

    public void setClimb_down(int climb_down2) {
        this.climb_down = climb_down2;
    }
}
