...
public class AmapLinearCheckBar extends LinearLayout implements OnCheckedChangedListener {
    ...
    public AmapLinearCheckBar(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        this.mContext = context;
    }

    public AmapLinearCheckBar(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
                ...
                view.setOnClickListener(new OnClickListener() {
                    public void onClick(View view) {
                        ...
                        if (!((CheckbleItemContainer) view).isChecked()) {
                            for (int j = 0; j < AmapLinearCheckBar.this.mContainerSparseArray.size(); j++) {
                                ((CheckbleItemContainer) AmapLinearCheckBar.this.mContainerSparseArray.valueAt(j)).setChecked(false);
                            }
