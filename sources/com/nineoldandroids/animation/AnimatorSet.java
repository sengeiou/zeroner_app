    ...
    public void cancel() {
        ...
        if (isStarted()) {
            ...
            if (this.mDelayAnim != null && this.mDelayAnim.isRunning()) {
                ...
                while (i$2.hasNext()) {
                    ((Node) i$2.next()).animation.cancel();
                }
            }
            if (tmpListeners != null) {
                Iterator i$3 = tmpListeners.iterator();
                while (i$3.hasNext()) {
                    ((AnimatorListener) i$3.next()).onAnimationEnd(this);
                }
            }
            this.mStarted = false;
        }
    ...
    public void start() {
        ...
        for (int i2 = 0; i2 < numSortedNodes; i2++) {
            ...
            if (this.mSetListener == null) {
                ...
                this.mSetListener = animatorSetListener;
            }
            if (node2.dependencies == null || node2.dependencies.size() == 0) {
                ...
                for (int j = 0; j < numDependencies; j++) {
                    ...
                    DependencyListener dependencyListener = new DependencyListener(this, node2, dependency.rule);
    ...
    public AnimatorSet clone() {
        ...
        while (it.hasNext()) {
            ...
            if (cloneListeners != null) {
                ...
                if (listenersToRemove != null) {
                    ...
                    while (i$2.hasNext()) {
                        cloneListeners.remove((AnimatorListener) i$2.next());
                    }
                }
            }
        }
        ...
        while (it2.hasNext()) {
            ...
            if (node2.dependencies != null) {
                ...
                while (i$3.hasNext()) {
                    Dependency dependency = (Dependency) i$3.next();
