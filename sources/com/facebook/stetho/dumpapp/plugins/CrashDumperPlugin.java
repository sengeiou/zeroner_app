...
public class CrashDumperPlugin implements DumperPlugin {
    ...
    private void doKill(DumperContext dumpContext, Iterator<String> argsIter) throws DumpException {
        ...
        try {
            kill = new ProcessBuilder(new String[0]).command(new String[]{"/system/bin/kill", HelpFormatter.DEFAULT_OPT_PREFIX + signal, String.valueOf(Process.myPid())}).redirectErrorStream(true).start();
