...
class FrameHelper {
    ...
    public static Frame createTextFrame(String payload) {
        return createSimpleFrame(1, Utf8Charset.encodeUTF8(payload));
    }

    public static Frame createBinaryFrame(byte[] payload) {
        return createSimpleFrame(2, payload);
    }
