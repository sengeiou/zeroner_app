...
public class NetworkEventReporterImpl implements NetworkEventReporter {
    ...
    public void requestWillBeSent(InspectorRequest request) {
        ...
        if (peerManager != null) {
            ...
            List<CallFrame> list = initiatorJSON.stackTrace;
            if (requestPriority != null) {
                i = requestPriority.intValue();
            } else {
                i = 0;
            }
            list.add(new CallFrame(requestFriendlyName, requestFriendlyName, i, 0));
    ...
    public void responseHeadersReceived(InspectorResponse response) {
        ...
        if (peerManager != null) {
            ...
            responseJSON.mimeType = contentType != null ? getResourceTypeHelper().stripContentExtras(contentType) : DfuBaseService.MIME_TYPE_OCTET_STREAM;
