...
public abstract class JSON implements JSONStreamAware, JSONAware {
    ...
    public static final JSONObject parseObject(String text, Feature... features) {
        ...
        if (autoTypeSupport) {
            jsonObject.put("@type", (Object) obj.getClass().getName());
        }
        return jsonObject;
    }
    ...
    public static final JSONArray parseArray(String text, Feature... features) {
        ...
        if (token == 8) {
            ...
            array = new JSONArray();
            parser.parseArray((Collection) array, (Object) null);
    ...
    public <T> T toJavaObject(Class<T> clazz) {
        return clazz == Map.class ? this : TypeUtils.cast(this, clazz, ParserConfig.getGlobalInstance(), 0);
    }
