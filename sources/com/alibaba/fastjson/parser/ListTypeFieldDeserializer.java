...
class ListTypeFieldDeserializer extends FieldDeserializer {
    ...
    public void parseField(com.alibaba.fastjson.parser.DefaultJSONParser r10, java.lang.Object r11, java.lang.reflect.Type r12, java.util.Map<java.lang.String, java.lang.Object> r13) {
        /*
            r9 = this;
            com.alibaba.fastjson.parser.JSONLexer r4 = r10.lexer
            int r6 = r4.token()
            r7 = 8
        ...
        L_0x0017:
            r7 = 0
            r9.setValue(r11, r7)
            com.alibaba.fastjson.parser.JSONLexer r7 = r10.lexer
            r7.nextToken()
        L_0x0020:
            return
        L_0x0021:
        ...
        L_0x0031:
            com.alibaba.fastjson.parser.ParseContext r1 = r10.contex
            com.alibaba.fastjson.util.FieldInfo r7 = r9.fieldInfo
    ...
    public final void parseArray(DefaultJSONParser parser, Type objectType, Collection array2) {
        ...
        } else if ((itemType2 instanceof TypeVariable) && (objectType instanceof Class)) {
            Class objectClass3 = (Class) objectType;
            TypeVariable typeVar3 = (TypeVariable) itemType2;
        ...
        if (lexer.token == 14) {
            ...
            while (true) {
                if (lexer.token == 16) {
                    ...
                    array2.add(itemTypeDeser.deserialze(parser, itemType2, Integer.valueOf(i4)));
