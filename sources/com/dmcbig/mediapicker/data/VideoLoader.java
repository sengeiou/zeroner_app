...
public class VideoLoader extends LoaderM implements LoaderCallbacks {
    ...
    public Loader onCreateLoader(int picker_type, Bundle bundle) {
        ...
        return new CursorLoader(this.mContext, queryUri, this.MEDIA_PROJECTION, "media_type=3", null, "date_added DESC");
    }

    public void onLoadFinished(Loader loader, Object o) {
        ArrayList<Folder> folders = new ArrayList<>();
        Folder allFolder = new Folder(this.mContext.getResources().getString(R.string.all_video));
