...
public final class Decoder {
    private static final String[] DIGIT_TABLE = {"CTRL_PS", MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR, "0", "1", "2", "3", "4", "5", Constants.VIA_SHARE_TYPE_INFO, "7", Constants.VIA_SHARE_TYPE_PUBLISHVIDEO, "9", ",", Consts.DOT, "CTRL_UL", "CTRL_US"};
    ...
    private static final String[] PUNCT_TABLE = {"", "\r", "\r\n", ". ", ", ", ": ", "!", "\"", "#", "$", "%", "&", "'", "(", ")", "*", "+", ",", HelpFormatter.DEFAULT_OPT_PREFIX, Consts.DOT, "/", ":", ";", "<", "=", ">", "?", "[", "]", "{", "}", "CTRL_UL"};
    private static final String[] UPPER_TABLE = {"CTRL_PS", MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR, GpsStatus.IN_PROGRESS, "B", "C", "D", GpsLongitudeRef.EAST, "F", "G", "H", "I", "J", GpsSpeedRef.KILOMETERS, "L", "M", "N", "O", "P", "Q", "R", GpsLatitudeRef.SOUTH, GpsTrackRef.TRUE_DIRECTION, "U", GpsStatus.INTEROPERABILITY, GpsLongitudeRef.WEST, "X", "Y", "Z", "CTRL_LL", "CTRL_ML", "CTRL_DL", "CTRL_BS"};
