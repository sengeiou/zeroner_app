...
final class PDF417HighLevelEncoder {
    ...
    private static final byte[] TEXT_PUNCTUATION_RAW = {59, 60, 62, 64, 91, 92, 93, Framer.STDIN_REQUEST_FRAME_PREFIX, 96, 126, Framer.ENTER_FRAME_PREFIX, Ascii.CR, 9, 44, 58, 10, Framer.STDIN_FRAME_PREFIX, 46, 36, 47, 34, 124, 42, 40, 41, 63, 123, 125, 39, 0};
    ...
    private static void encodeBinary(byte[] bytes, int startpos, int count, int startmode, StringBuilder sb) {
        ...
        if (count >= 6) {
            ...
            while ((startpos + count) - idx >= 6) {
                long t = 0;
                for (int i = 0; i < 6; i++) {
                    t = (t << 8) + ((long) (bytes[idx + i] & UnsignedBytes.MAX_VALUE));
                }
