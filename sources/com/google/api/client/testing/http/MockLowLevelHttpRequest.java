...
public class MockLowLevelHttpRequest extends LowLevelHttpRequest {
    ...
    public void addHeader(String name, String value) throws IOException {
        ...
        List<String> values = (List) this.headersMap.get(name2);
        if (values == null) {
    ...
    public String getContentAsString() throws IOException {
        ...
        return out.toString(((mediaType == null || mediaType.getCharsetParameter() == null) ? Charsets.ISO_8859_1 : mediaType.getCharsetParameter()).name());
    }
