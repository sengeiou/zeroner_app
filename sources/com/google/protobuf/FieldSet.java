...
final class FieldSet<FieldDescriptorType extends FieldDescriptorLite<FieldDescriptorType>> {
    ...
    static void writeElement(CodedOutputStream output, FieldType type, int number, Object value) throws IOException {
    ...
    static int computeElementSize(FieldType type, int number, Object value) {
