...
public class MapEntryLite<K, V> {
    ...
    static class Metadata<K, V> {
        ...
        public Metadata(FieldType keyType2, K defaultKey2, FieldType valueType2, V defaultValue2) {
    ...
    private MapEntryLite(FieldType keyType, K defaultKey, FieldType valueType, V defaultValue) {
    ...
    public static <K, V> MapEntryLite<K, V> newDefaultInstance(FieldType keyType, K defaultKey, FieldType valueType, V defaultValue) {
    ...
    static <T> T parseField(CodedInputStream input, ExtensionRegistryLite extensionRegistry, FieldType type, T value2) throws IOException {
        switch (type) {
            case MESSAGE:
                Builder subBuilder = ((MessageLite) value2).toBuilder();
    ...
    static <K, V> Entry<K, V> parseEntry(CodedInputStream input, Metadata<K, V> metadata2, ExtensionRegistryLite extensionRegistry) throws IOException {
        ...
        return new SimpleImmutableEntry(key2, value2);
    }
