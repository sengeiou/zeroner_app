...
public abstract class CodedOutputStream extends ByteOutput {
        ...
        public final void bufferUInt32NoTag(int value) {
            if (CodedOutputStream.HAS_UNSAFE_ARRAY_OPERATIONS) {
                ...
                while ((value & -128) != 0) {
                    ...
                    int i = this.position;
                    this.position = i + 1;
                    UnsafeUtil.putByte(bArr, (long) i, (byte) ((value & Opcodes.NEG_FLOAT) | 128));
                    value >>>= 7;
                }
            ...
            while ((value & -128) != 0) {
                ...
                this.position = i3 + 1;
                bArr3[i3] = (byte) ((value & Opcodes.NEG_FLOAT) | 128);
                this.totalBytesWritten++;
                value >>>= 7;
            }
        ...
        public final void bufferUInt64NoTag(long value) {
            if (CodedOutputStream.HAS_UNSAFE_ARRAY_OPERATIONS) {
                ...
                while ((value & -128) != 0) {
                    ...
                    int i = this.position;
                    this.position = i + 1;
                    UnsafeUtil.putByte(bArr, (long) i, (byte) ((((int) value) & Opcodes.NEG_FLOAT) | 128));
                    value >>>= 7;
                }
                byte[] bArr2 = this.buffer;
                int i2 = this.position;
            ...
            while ((value & -128) != 0) {
                ...
                int i3 = this.position;
                this.position = i3 + 1;
                bArr3[i3] = (byte) ((((int) value) & Opcodes.NEG_FLOAT) | 128);
                this.totalBytesWritten++;
                value >>>= 7;
            }
            byte[] bArr4 = this.buffer;
    ...
    private static class ArrayEncoder extends CodedOutputStream {
        ...
        public final void writeUInt32NoTag(int value) throws IOException {
            if (!CodedOutputStream.HAS_UNSAFE_ARRAY_OPERATIONS || spaceLeft() < 10) {
                while ((value & -128) != 0) {
                    try {
                        ...
                        int i = this.position;
                        this.position = i + 1;
                        bArr[i] = (byte) ((value & Opcodes.NEG_FLOAT) | 128);
                        value >>>= 7;
                    } catch (IndexOutOfBoundsException e) {
                        throw new OutOfSpaceException(String.format("Pos: %d, limit: %d, len: %d", new Object[]{Integer.valueOf(this.position), Integer.valueOf(this.limit), Integer.valueOf(1)}), e);
                    }
            ...
            while ((value & -128) != 0) {
                ...
                int i3 = this.position;
                this.position = i3 + 1;
                UnsafeUtil.putByte(bArr3, (long) i3, (byte) ((value & Opcodes.NEG_FLOAT) | 128));
                value >>>= 7;
            }
            byte[] bArr4 = this.buffer;
            int i4 = this.position;
            this.position = i4 + 1;
            UnsafeUtil.putByte(bArr4, (long) i4, (byte) value);
        }
        ...
        public final void writeUInt64NoTag(long value) throws IOException {
            if (!CodedOutputStream.HAS_UNSAFE_ARRAY_OPERATIONS || spaceLeft() < 10) {
                while ((value & -128) != 0) {
                    try {
                        ...
                        int i = this.position;
                        this.position = i + 1;
                        bArr[i] = (byte) ((((int) value) & Opcodes.NEG_FLOAT) | 128);
                        value >>>= 7;
                    } catch (IndexOutOfBoundsException e) {
                        throw new OutOfSpaceException(String.format("Pos: %d, limit: %d, len: %d", new Object[]{Integer.valueOf(this.position), Integer.valueOf(this.limit), Integer.valueOf(1)}), e);
                    }
            ...
            while ((value & -128) != 0) {
                ...
                int i3 = this.position;
                this.position = i3 + 1;
                UnsafeUtil.putByte(bArr3, (long) i3, (byte) ((((int) value) & Opcodes.NEG_FLOAT) | 128));
                value >>>= 7;
            }
            byte[] bArr4 = this.buffer;
            int i4 = this.position;
    ...
    private static final class SafeDirectNioEncoder extends CodedOutputStream {
        ...
        public void writeUInt32NoTag(int value) throws IOException {
            while ((value & -128) != 0) {
                this.buffer.put((byte) ((value & Opcodes.NEG_FLOAT) | 128));
                value >>>= 7;
            }
            try {
        ...
        public void writeUInt64NoTag(long value) throws IOException {
            while ((-128 & value) != 0) {
                this.buffer.put((byte) ((((int) value) & Opcodes.NEG_FLOAT) | 128));
                value >>>= 7;
            }
            try {
        ...
        public void writeUInt32NoTag(int value) throws IOException {
            if (this.position <= this.oneVarintLimit) {
                while ((value & -128) != 0) {
                    long j = this.position;
                    this.position = j + 1;
                    UnsafeUtil.putByte(j, (byte) ((value & Opcodes.NEG_FLOAT) | 128));
                    value >>>= 7;
                }
            ...
            while (this.position < this.limit) {
                ...
                this.position = j4 + 1;
                UnsafeUtil.putByte(j4, (byte) ((value & Opcodes.NEG_FLOAT) | 128));
                value >>>= 7;
            }
            throw new OutOfSpaceException(String.format("Pos: %d, limit: %d, len: %d", new Object[]{Long.valueOf(this.position), Long.valueOf(this.limit), Integer.valueOf(1)}));
        }
        ...
        public void writeUInt64NoTag(long value) throws IOException {
            if (this.position <= this.oneVarintLimit) {
                while ((value & -128) != 0) {
                    long j = this.position;
                    this.position = j + 1;
                    UnsafeUtil.putByte(j, (byte) ((((int) value) & Opcodes.NEG_FLOAT) | 128));
                    value >>>= 7;
                }
                long j2 = this.position;
                this.position = j2 + 1;
            ...
            while (this.position < this.limit) {
                ...
                long j4 = this.position;
                this.position = j4 + 1;
                UnsafeUtil.putByte(j4, (byte) ((((int) value) & Opcodes.NEG_FLOAT) | 128));
                value >>>= 7;
            }
            throw new OutOfSpaceException(String.format("Pos: %d, limit: %d, len: %d", new Object[]{Long.valueOf(this.position), Long.valueOf(this.limit), Integer.valueOf(1)}));
        }
