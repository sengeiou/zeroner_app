...
public abstract class CodedInputStream {
    ...
    private static final class ArrayDecoder extends CodedInputStream {
        ...
        public String readStringRequireUtf8() throws IOException {
            ...
            if (size <= 0 || size > this.limit - this.pos) {
                ...
                throw InvalidProtocolBufferException.truncatedMessage();
            } else if (!Utf8.isValidUtf8(this.buffer, this.pos, this.pos + size)) {
                throw InvalidProtocolBufferException.invalidUtf8();
            } else {
                int tempPos = this.pos;
                this.pos += size;
                return new String(this.buffer, tempPos, size, Internal.UTF_8);
            }
        }
        ...
        public int readRawLittleEndian32() throws IOException {
            ...
            this.pos = tempPos + 4;
            return (buffer2[tempPos] & UnsignedBytes.MAX_VALUE) | ((buffer2[tempPos + 1] & UnsignedBytes.MAX_VALUE) << 8) | ((buffer2[tempPos + 2] & UnsignedBytes.MAX_VALUE) << 16) | ((buffer2[tempPos + 3] & UnsignedBytes.MAX_VALUE) << Ascii.CAN);
        }
    ...
    private static final class IterableDirectByteBufferDecoder extends CodedInputStream {
        ...
        public int readRawLittleEndian32() throws IOException {
            ...
            return (UnsafeUtil.getByte(tempPos) & UnsignedBytes.MAX_VALUE) | ((UnsafeUtil.getByte(1 + tempPos) & UnsignedBytes.MAX_VALUE) << 8) | ((UnsafeUtil.getByte(2 + tempPos) & UnsignedBytes.MAX_VALUE) << 16) | ((UnsafeUtil.getByte(3 + tempPos) & UnsignedBytes.MAX_VALUE) << Ascii.CAN);
        }
    ...
    private static final class StreamDecoder extends CodedInputStream {
        ...
        public String readStringRequireUtf8() throws IOException {
            ...
            if (Utf8.isValidUtf8(bytes, tempPos, tempPos + size)) {
                return new String(bytes, tempPos, size, Internal.UTF_8);
            }
            throw InvalidProtocolBufferException.invalidUtf8();
        }
        ...
        private ByteString readBytesSlowPath(int size) throws IOException {
            ...
            this.bufferSize = 0;
            List<byte[]> chunks = readRawBytesSlowPathRemainingChunks(size - bufferedBytes);
            List<ByteString> byteStrings = new ArrayList<>(chunks.size() + 1);
    ...
    public static int readRawVarint32(int firstByte, InputStream input) throws IOException {
        ...
        int result = firstByte & Opcodes.NEG_FLOAT;
        int offset = 7;
        while (offset < 32) {
            int b = input.read();
            if (b == -1) {
            ...
            result |= (b & Opcodes.NEG_FLOAT) << offset;
            if ((b & 128) == 0) {
                return result;
            }
            offset += 7;
