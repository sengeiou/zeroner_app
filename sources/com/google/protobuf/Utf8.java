...
final class Utf8 {
            ...
            while (offset < limit) {
                ...
                if (DecodeUtil.isOneByte(byte1)) {
                    ...
                    while (true) {
                        ...
                        offset3++;
                        int resultPos6 = resultPos5 + 1;
                        DecodeUtil.handleOneByte(b2, resultArr, resultPos5);
                        resultPos5 = resultPos6;
                    }
                    ...
                    offset3 = offset5 + 1;
                    int resultPos8 = resultPos + 1;
                    DecodeUtil.handleThreeBytes(byte1, b3, buffer.get(offset5), resultArr, resultPos);
                    resultPos2 = resultPos8;
                    ...
                    byte b5 = buffer.get(offset6);
                    int offset8 = offset7 + 1;
                    int resultPos9 = resultPos + 1;
                    DecodeUtil.handleFourBytes(byte1, b4, b5, buffer.get(offset7), resultArr, resultPos);
                    resultPos2 = resultPos9 + 1;
                    offset3 = offset8;
                }
                offset = offset3;
            }
            ...
            while (inIx < inLength) {
                try {
                    ...
                    if (c2 < 128) {
                        ...
                        outIx = outIx2 + 1;
                        out.put(outIx2, (byte) ((c2 >>> 6) | Opcodes.AND_LONG_2ADDR));
                        out.put(outIx, (byte) ((c2 & '?') | 128));
                    } else if (c2 < 55296 || 57343 < c2) {
                        outIx = outIx2 + 1;
                        out.put(outIx2, (byte) ((c2 >>> 12) | Opcodes.SHL_INT_LIT8));
                        outIx2 = outIx + 1;
    ...
    static final class SafeProcessor extends Processor {
         ...
         */
        /* JADX WARNING: Incorrect type for immutable var: ssa=byte, code=int, for r1v2, types: [int, byte] */
        ...
        public String decodeUtf8(byte[] bytes, int index, int size) throws InvalidProtocolBufferException {
            ...
            while (offset < limit) {
                ...
                if (DecodeUtil.isOneByte(byte1)) {
                    ...
                    offset3 = offset5 + 1;
                    int resultPos8 = resultPos + 1;
                    DecodeUtil.handleThreeBytes(byte1, b3, bytes[offset5], resultArr, resultPos);
                    resultPos2 = resultPos8;
                } else if (offset3 >= limit - 2) {
                    throw InvalidProtocolBufferException.invalidUtf8();
                } else {
                    ...
                    int offset7 = offset6 + 1;
                    byte b5 = bytes[offset6];
                    int offset8 = offset7 + 1;
                    int resultPos9 = resultPos + 1;
                    DecodeUtil.handleFourBytes(byte1, b4, b5, bytes[offset7], resultArr, resultPos);
                    resultPos2 = resultPos9 + 1;
                    offset3 = offset8;
                }
                offset = offset3;
                ...
                if (c2 < 128 && j3 < limit) {
                    ...
                    if (i + 1 != in.length()) {
                        ...
                        if (Character.isSurrogatePair(c2, low)) {
                            ...
                            int j9 = j8 + 1;
                            out[j8] = (byte) (((codePoint >>> 12) & 63) | 128);
                            int j10 = j9 + 1;
                            out[j9] = (byte) (((codePoint >>> 6) & 63) | 128);
                            int j11 = j10 + 1;
                            out[j10] = (byte) ((codePoint & 63) | 128);
                            j = j11;
                        }
                    }
        ...
        public String decodeUtf8(byte[] bytes, int index, int size) throws InvalidProtocolBufferException {
            ...
            while (offset < limit) {
                ...
                if (DecodeUtil.isOneByte(byte1)) {
                    ...
                    offset3 = offset5 + 1;
                    int resultPos8 = resultPos + 1;
                    DecodeUtil.handleThreeBytes(byte1, b3, UnsafeUtil.getByte(bytes, (long) offset5), resultArr, resultPos);
                    resultPos2 = resultPos8;
                } else if (offset3 >= limit - 2) {
                    throw InvalidProtocolBufferException.invalidUtf8();
                } else {
                    ...
                    int offset7 = offset6 + 1;
                    byte b5 = UnsafeUtil.getByte(bytes, (long) offset6);
                    int offset8 = offset7 + 1;
                    int resultPos9 = resultPos + 1;
                    DecodeUtil.handleFourBytes(byte1, b4, b5, UnsafeUtil.getByte(bytes, (long) offset7), resultArr, resultPos);
                    resultPos2 = resultPos9 + 1;
                    offset3 = offset8;
                }
                offset = offset3;
            ...
            while (true) {
                ...
                if (address3 < addressLimit) {
                    ...
                    if (DecodeUtil.isOneByte(byte1)) {
                        ...
                        address = address5 + 1;
                        int resultPos8 = resultPos + 1;
                        DecodeUtil.handleThreeBytes(byte1, b3, UnsafeUtil.getByte(address5), resultArr, resultPos);
                        resultPos2 = resultPos8;
                        ...
                        byte b5 = UnsafeUtil.getByte(address6);
                        long address8 = address7 + 1;
                        int resultPos9 = resultPos + 1;
                        DecodeUtil.handleFourBytes(byte1, b4, b5, UnsafeUtil.getByte(address7), resultArr, resultPos);
                        resultPos2 = resultPos9 + 1;
                        address = address8;
                    }
                } else {
