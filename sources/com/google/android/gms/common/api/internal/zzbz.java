...
public final class zzbz {
    ...
    private static zzbz zzfz(String str) {
        ...
        synchronized (sLock) {
            if (zzfty == null) {
                throw new IllegalStateException(new StringBuilder(String.valueOf(str).length() + 34).append("Initialize must be called before ").append(str).append(Consts.DOT).toString());
            }
            zzbz = zzfty;
        }
        return zzbz;
