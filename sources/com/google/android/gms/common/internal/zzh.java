    ...
    public final void handleMessage(Message message) {
        ...
        if (this.zzfza.zzfyx.get() != message.arg1) {
            ...
            if (!this.zzfza.zzakq() || this.zzfza.zzfyw) {
                ConnectionResult connectionResult = this.zzfza.zzfyv != null ? this.zzfza.zzfyv : new ConnectionResult(8);
            ...
            ConnectionResult connectionResult2 = this.zzfza.zzfyv != null ? this.zzfza.zzfyv : new ConnectionResult(8);
            this.zzfza.zzfym.zzf(connectionResult2);
            this.zzfza.onConnectionFailed(connectionResult2);
