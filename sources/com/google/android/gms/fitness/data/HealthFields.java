...
public final class HealthFields {
    ...
    public static final Field FIELD_BLOOD_GLUCOSE_LEVEL = Field.zzhi("blood_glucose_level");
    public static final Field FIELD_BLOOD_GLUCOSE_SPECIMEN_SOURCE = Field.zzhh("blood_glucose_specimen_source");
    public static final Field FIELD_BLOOD_PRESSURE_DIASTOLIC = Field.zzhi("blood_pressure_diastolic");
    public static final Field FIELD_BLOOD_PRESSURE_DIASTOLIC_AVERAGE = Field.zzhi("blood_pressure_diastolic_average");
    public static final Field FIELD_BLOOD_PRESSURE_DIASTOLIC_MAX = Field.zzhi("blood_pressure_diastolic_max");
    public static final Field FIELD_BLOOD_PRESSURE_DIASTOLIC_MIN = Field.zzhi("blood_pressure_diastolic_min");
    public static final Field FIELD_BLOOD_PRESSURE_MEASUREMENT_LOCATION = Field.zzhh("blood_pressure_measurement_location");
    public static final Field FIELD_BLOOD_PRESSURE_SYSTOLIC = Field.zzhi("blood_pressure_systolic");
    public static final Field FIELD_BLOOD_PRESSURE_SYSTOLIC_AVERAGE = Field.zzhi("blood_pressure_systolic_average");
    public static final Field FIELD_BLOOD_PRESSURE_SYSTOLIC_MAX = Field.zzhi("blood_pressure_systolic_max");
    public static final Field FIELD_BLOOD_PRESSURE_SYSTOLIC_MIN = Field.zzhi("blood_pressure_systolic_min");
    public static final Field FIELD_BODY_POSITION = Field.zzhh("body_position");
    public static final Field FIELD_BODY_TEMPERATURE = Field.zzhi("body_temperature");
    public static final Field FIELD_BODY_TEMPERATURE_MEASUREMENT_LOCATION = Field.zzhh("body_temperature_measurement_location");
    public static final Field FIELD_CERVICAL_DILATION = Field.zzhh("cervical_dilation");
    public static final Field FIELD_CERVICAL_FIRMNESS = Field.zzhh("cervical_firmness");
    public static final Field FIELD_CERVICAL_MUCUS_AMOUNT = Field.zzhh("cervical_mucus_amount");
    public static final Field FIELD_CERVICAL_MUCUS_TEXTURE = Field.zzhh("cervical_mucus_texture");
    public static final Field FIELD_CERVICAL_POSITION = Field.zzhh("cervical_position");
    public static final Field FIELD_MENSTRUAL_FLOW = Field.zzhh("menstrual_flow");
    public static final Field FIELD_OVULATION_TEST_RESULT = Field.zzhh("ovulation_test_result");
    public static final Field FIELD_OXYGEN_SATURATION = Field.zzhi("oxygen_saturation");
    public static final Field FIELD_OXYGEN_SATURATION_AVERAGE = Field.zzhi("oxygen_saturation_average");
    public static final Field FIELD_OXYGEN_SATURATION_MAX = Field.zzhi("oxygen_saturation_max");
    public static final Field FIELD_OXYGEN_SATURATION_MEASUREMENT_METHOD = Field.zzhh("oxygen_saturation_measurement_method");
    public static final Field FIELD_OXYGEN_SATURATION_MIN = Field.zzhi("oxygen_saturation_min");
    public static final Field FIELD_OXYGEN_SATURATION_SYSTEM = Field.zzhh("oxygen_saturation_system");
    public static final Field FIELD_OXYGEN_THERAPY_ADMINISTRATION_MODE = Field.zzhh("oxygen_therapy_administration_mode");
    public static final Field FIELD_SUPPLEMENTAL_OXYGEN_FLOW_RATE = Field.zzhi("supplemental_oxygen_flow_rate");
    public static final Field FIELD_SUPPLEMENTAL_OXYGEN_FLOW_RATE_AVERAGE = Field.zzhi("supplemental_oxygen_flow_rate_average");
    public static final Field FIELD_SUPPLEMENTAL_OXYGEN_FLOW_RATE_MAX = Field.zzhi("supplemental_oxygen_flow_rate_max");
    public static final Field FIELD_SUPPLEMENTAL_OXYGEN_FLOW_RATE_MIN = Field.zzhi("supplemental_oxygen_flow_rate_min");
    public static final Field FIELD_TEMPORAL_RELATION_TO_MEAL = Field.zzhh("temporal_relation_to_meal");
    ...
    public static final Field FIELD_TEMPORAL_RELATION_TO_SLEEP = Field.zzhh("temporal_relation_to_sleep");
