...
public final class zzbfn {
    ...
    private static void zza(Parcel parcel, int i, int i2) {
        ...
        if (zza != i2) {
            ...
            throw new zzbfo(new StringBuilder(String.valueOf(hexString).length() + 46).append("Expected size ").append(i2).append(" got ").append(zza).append(" (0x").append(hexString).append(")").toString(), parcel);
        }
    }
    ...
    public static int zzd(Parcel parcel) {
        ...
        throw new zzbfo("Size read is invalid start=" + dataPosition + " end=" + i, parcel);
    }
