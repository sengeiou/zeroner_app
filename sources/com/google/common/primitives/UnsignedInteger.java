...
public final class UnsignedInteger extends Number implements Comparable<UnsignedInteger> {
    ...
    public static UnsignedInteger valueOf(long value2) {
        boolean z;
        if ((4294967295L & value2) == value2) {
            z = true;
        } else {
            z = false;
        }
        Preconditions.checkArgument(z, "value (%s) is outside the range for an unsigned integer value", Long.valueOf(value2));
    ...
    public static UnsignedInteger valueOf(BigInteger value2) {
        ...
        if (value2.signum() < 0 || value2.bitLength() > 32) {
            z = false;
        } else {
            z = true;
        }
        Preconditions.checkArgument(z, "value (%s) is outside the range for an unsigned integer value", value2);
