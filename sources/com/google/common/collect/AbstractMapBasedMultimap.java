...
abstract class AbstractMapBasedMultimap<K, V> extends AbstractMultimap<K, V> implements Serializable {
    ...
    private class WrappedCollection extends AbstractCollection<V> {
        ...
        WrappedCollection(@Nullable K key2, Collection<V> delegate2, @Nullable WrappedCollection ancestor2) {
            this.key = key2;
    ...
    private class WrappedList extends WrappedCollection implements List<V> {
        ...
        /* JADX WARNING: type inference failed for: r4v1, types: [com.google.common.collect.AbstractMapBasedMultimap$WrappedCollection] */
    ...
    protected class WrappedSortedSet extends WrappedCollection implements SortedSet<V> {
        ...
        /* JADX WARNING: type inference failed for: r5v1, types: [com.google.common.collect.AbstractMapBasedMultimap$WrappedCollection] */
        /* JADX WARNING: Multi-variable type inference failed */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public java.util.SortedSet<V> headSet(V r6) {
            /*
                r5 = this;
                r5.refreshIfEmpty()
                ...
                java.util.SortedSet r3 = r5.getSortedSetDelegate()
                java.util.SortedSet r3 = r3.headSet(r6)
                com.google.common.collect.AbstractMapBasedMultimap$WrappedCollection r4 = r5.getAncestor()
                if (r4 != 0) goto L_0x001d
            L_0x0019:
                r0.<init>(r2, r3, r5)
                return r0
            L_0x001d:
                com.google.common.collect.AbstractMapBasedMultimap$WrappedCollection r5 = r5.getAncestor()
                goto L_0x0019
            */
        ...
        /* JADX WARNING: Multi-variable type inference failed */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public java.util.SortedSet<V> subSet(V r6, V r7) {
            /*
                r5 = this;
                r5.refreshIfEmpty()
                com.google.common.collect.AbstractMapBasedMultimap$WrappedSortedSet r0 = new com.google.common.collect.AbstractMapBasedMultimap$WrappedSortedSet
                ...
                java.lang.Object r2 = r5.getKey()
                java.util.SortedSet r3 = r5.getSortedSetDelegate()
                java.util.SortedSet r3 = r3.subSet(r6, r7)
                com.google.common.collect.AbstractMapBasedMultimap$WrappedCollection r4 = r5.getAncestor()
                if (r4 != 0) goto L_0x001d
            L_0x0019:
                r0.<init>(r2, r3, r5)
        ...
        /* JADX WARNING: Multi-variable type inference failed */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public java.util.SortedSet<V> tailSet(V r6) {
            /*
                r5 = this;
                r5.refreshIfEmpty()
                com.google.common.collect.AbstractMapBasedMultimap$WrappedSortedSet r0 = new com.google.common.collect.AbstractMapBasedMultimap$WrappedSortedSet
                ...
                java.lang.Object r2 = r5.getKey()
                java.util.SortedSet r3 = r5.getSortedSetDelegate()
                java.util.SortedSet r3 = r3.tailSet(r6)
                com.google.common.collect.AbstractMapBasedMultimap$WrappedCollection r4 = r5.getAncestor()
                if (r4 != 0) goto L_0x001d
            L_0x0019:
                r0.<init>(r2, r3, r5)
    ...
    /* access modifiers changed from: private */
    public List<V> wrapList(@Nullable K key, List<V> list, @Nullable WrappedCollection ancestor) {
