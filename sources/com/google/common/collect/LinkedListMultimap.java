...
public class LinkedListMultimap<K, V> extends AbstractMultimap<K, V> implements ListMultimap<K, V>, Serializable {
    ...
    public Node<K, V> addNode(@Nullable K key, @Nullable V value, @Nullable Node<K, V> nextSibling) {
        ...
        if (this.head == null) {
            ...
            KeyList<K, V> keyList2 = (KeyList) this.keyToKeyList.get(key);
            keyList2.count++;
    ...
    private List<V> getCopy(@Nullable Object key) {
        return Collections.unmodifiableList(Lists.newArrayList((Iterator<? extends E>) new ValueForKeyIterator<Object>(key)));
    }
