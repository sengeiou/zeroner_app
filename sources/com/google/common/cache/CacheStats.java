...
public final class CacheStats {
    ...
    public double missRate() {
        long requestCount = requestCount();
        return requestCount == 0 ? Utils.DOUBLE_EPSILON : ((double) this.missCount) / ((double) requestCount);
    }
    ...
    public double loadExceptionRate() {
        ...
        return totalLoadCount == 0 ? Utils.DOUBLE_EPSILON : ((double) this.loadExceptionCount) / ((double) totalLoadCount);
    }
    ...
    public double averageLoadPenalty() {
        long totalLoadCount = this.loadSuccessCount + this.loadExceptionCount;
        return totalLoadCount == 0 ? Utils.DOUBLE_EPSILON : ((double) this.totalLoadTime) / ((double) totalLoadCount);
    }
