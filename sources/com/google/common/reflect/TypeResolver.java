    ...
    private static final class WildcardCapturer {
        ...
        public Type capture(Type type) {
            ...
            if (type instanceof ParameterizedType) {
                ...
                return Types.newArtificialTypeVariable(WildcardCapturer.class, "capture#" + this.id.incrementAndGet() + "-of ? extends " + Joiner.on((char) Typography.amp).join((Object[]) wildcardType.getUpperBounds()), wildcardType.getUpperBounds());
            } else {
