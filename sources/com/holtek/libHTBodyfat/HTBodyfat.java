...
public class HTBodyfat {
    ...
    public static native int RR();

    public static native double SS();

    public static native double[] TT();

    public static native int UU();

    public static native int VV();

    public static native double WW();

    public static native double XX();
