...
public abstract class Config {
    ...
    public Config(Retrofit retrofit3) {
    ...
    protected static Retrofit createRetrofit(boolean debug2, String baseURL, Interceptor... interceptors) {
        ...
        return new Retrofit.Builder().baseUrl(baseURL).client(builder.build()).addConverterFactory(GsonConverterFactory.create(makeGson())).build();
    }
