...
public class Dropper extends AssociationUpdater {
    ...
    private List<String> findTablesToDrop() {
        ...
        Cursor cursor = null;
        try {
            Cursor cursor2 = this.mDb.query(TableSchema.TABLE_NAME, null, null, null, null, null, null);
            if (cursor2.moveToFirst()) {
                do {
                    String tableName = cursor2.getString(cursor2.getColumnIndexOrThrow(TableSchema.COLUMN_NAME));
