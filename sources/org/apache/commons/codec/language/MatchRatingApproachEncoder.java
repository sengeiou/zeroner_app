...
public class MatchRatingApproachEncoder implements StringEncoder {
    ...
    public boolean isVowel(String letter) {
        return letter.equalsIgnoreCase(GpsLongitudeRef.EAST) || letter.equalsIgnoreCase(GpsStatus.IN_PROGRESS) || letter.equalsIgnoreCase("O") || letter.equalsIgnoreCase("I") || letter.equalsIgnoreCase("U");
    }
    ...
    public String removeVowels(String name) {
        ...
        String name2 = name.replaceAll(GpsStatus.IN_PROGRESS, "").replaceAll(GpsLongitudeRef.EAST, "").replaceAll("I", "").replaceAll("O", "").replaceAll("U", "").replaceAll("\\s{2,}\\b", " ");
