...
class CollectionsKt__CollectionsKt {
    ...
    public static final <T> List<T> optimizeReadOnlyList(@NotNull List<? extends T> $receiver) {
        ...
        switch ($receiver.size()) {
            case 0:
                return CollectionsKt.emptyList();
            case 1:
                return CollectionsKt.listOf((T) $receiver.get(0));
            default:
                return $receiver;
        }
    }
    ...
    private static final <T> T[] copyToArrayImpl(Collection<?> collection, T[] array) {
        ...
        Intrinsics.checkExpressionValueIsNotNull(array2, "kotlin.jvm.internal.Coll…oArray(collection, array)");
        return array2;
    }

    /* access modifiers changed from: private */
    public static final <T> Object[] copyToArrayOfAny$CollectionsKt__CollectionsKt(@NotNull T[] $receiver, boolean isVarargs) {
    ...
    public static /* bridge */ /* synthetic */ int binarySearchBy$default(List $receiver, Comparable key, int fromIndex, int toIndex, Function1 selector, int i, Object obj) {
        ...
        return CollectionsKt.binarySearch($receiver, fromIndex, toIndex, (Function1<? super T, Integer>) new CollectionsKt__CollectionsKt$binarySearchBy$1<Object,Integer>(selector, key));
    }
