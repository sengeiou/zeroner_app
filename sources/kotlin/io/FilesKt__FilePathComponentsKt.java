    ...
    private static final int getRootLength$FilesKt__FilePathComponentsKt(@NotNull String $receiver) {
        ...
        if (first == 0) {
            if ($receiver.length() > 1 && $receiver.charAt(1) == File.separatorChar) {
                int first2 = StringsKt.indexOf$default((CharSequence) $receiver, File.separatorChar, 2, false, 4, (Object) null);
                if (first2 >= 0) {
                    int first3 = StringsKt.indexOf$default((CharSequence) $receiver, File.separatorChar, first2 + 1, false, 4, (Object) null);
                    if (first3 >= 0) {
                        return first3 + 1;
                    }
            ...
            if (first != -1 || !StringsKt.endsWith$default((CharSequence) $receiver, ':', false, 2, (Object) null)) {
                return 0;
            }
            return $receiver.length();
        }
