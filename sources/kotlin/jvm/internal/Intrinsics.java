...
public class Intrinsics {
    ...
    public static void checkReturnedValueIsNotNull(Object value, String className, String methodName) {
        if (value == null) {
            throw ((IllegalStateException) sanitizeStackTrace(new IllegalStateException("Method specified as non-null returned null: " + className + Consts.DOT + methodName)));
        }
    }
    ...
    public static void checkFieldIsNotNull(Object value, String className, String fieldName) {
        if (value == null) {
            throw ((IllegalStateException) sanitizeStackTrace(new IllegalStateException("Field specified as non-null is null: " + className + Consts.DOT + fieldName)));
        }
    }
    ...
    private static void throwParameterIsNullException(String paramName) {
        ...
        throw ((IllegalArgumentException) sanitizeStackTrace(new IllegalArgumentException("Parameter specified as non-null is null: method " + className + Consts.DOT + caller.getMethodName() + ", parameter " + paramName)));
    }
