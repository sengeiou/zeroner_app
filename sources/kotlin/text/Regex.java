...
public final class Regex {
    ...
    public Regex(@NotNull Pattern nativePattern2) {
        ...
        CollectionsKt.retainAll((Iterable<? extends T>) $receiver$iv, (Function1<? super T, Boolean>) new Regex$fromInt$$inlined$apply$lambda$1<Object,Boolean>(flags));
        Set<RegexOption> unmodifiableSet = Collections.unmodifiableSet($receiver$iv);
    ...
    public Regex(@NotNull String pattern, @NotNull Set<? extends RegexOption> options2) {
        ...
        Pattern compile = Pattern.compile(pattern, Companion.ensureUnicodeCase(RegexKt.toInt(options2)));
    ...
    public final List<String> split(@NotNull CharSequence input, int limit) {
        ...
        return ArraysKt.asList((T[]) (Object[]) pattern.split(input, limit));
    }
