...
public final class ObservableSwitchMapCompletable<T> extends Completable {
    ...
    static final class SwitchMapCompletableObserver<T> implements Observer<T>, Disposable {
        ...
        public void onNext(T t) {
            ...
            try {
                ...
                do {
                    current = (SwitchMapInnerObserver) this.inner.get();
    ...
    public void subscribeActual(CompletableObserver s) {
        if (!ScalarXMapZHelper.tryAsCompletable(this.source, this.mapper, s)) {
            this.source.subscribe((Observer<? super T>) new SwitchMapCompletableObserver<Object>(s, this.mapper, this.delayErrors));
        }
    }
}
