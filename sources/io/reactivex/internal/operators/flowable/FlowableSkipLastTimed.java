...
public final class FlowableSkipLastTimed<T> extends AbstractFlowableWithUpstream<T, T> {
    ...
    public void subscribeActual(Subscriber<? super T> s) {
        this.source.subscribe((FlowableSubscriber<? super T>) new SkipLastTimedSubscriber<Object>(s, this.time, this.unit, this.scheduler, this.bufferSize, this.delayError));
    }
}
