...
public final class FlowableMap<T, U> extends AbstractFlowableWithUpstream<T, U> {
    ...
    public void subscribeActual(Subscriber<? super U> s) {
        if (s instanceof ConditionalSubscriber) {
            this.source.subscribe((FlowableSubscriber<? super T>) new MapConditionalSubscriber<Object>((ConditionalSubscriber) s, this.mapper));
        } else {
            this.source.subscribe((FlowableSubscriber<? super T>) new MapSubscriber<Object>(s, this.mapper));
        }
    }
}
