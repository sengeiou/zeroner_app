...
public final class FlowableObserveOn<T> extends AbstractFlowableWithUpstream<T, T> {
    ...
    static abstract class BaseObserveOnSubscriber<T> extends BasicIntQueueSubscription<T> implements FlowableSubscriber<T>, Runnable {
        ...
        BaseObserveOnSubscriber(Worker worker2, boolean delayError2, int prefetch2) {
            this.worker = worker2;
    ...
    static final class ObserveOnConditionalSubscriber<T> extends BaseObserveOnSubscriber<T> {
        ...
        ObserveOnConditionalSubscriber(ConditionalSubscriber<? super T> actual2, Worker worker, boolean delayError, int prefetch) {
    ...
    static final class ObserveOnSubscriber<T> extends BaseObserveOnSubscriber<T> implements FlowableSubscriber<T> {
        ...
        ObserveOnSubscriber(Subscriber<? super T> actual2, Worker worker, boolean delayError, int prefetch) {
            super(worker, delayError, prefetch);
            this.actual = actual2;
        }
    ...
    public void subscribeActual(Subscriber<? super T> s) {
        ...
        if (s instanceof ConditionalSubscriber) {
            this.source.subscribe((FlowableSubscriber<? super T>) new ObserveOnConditionalSubscriber<Object>((ConditionalSubscriber) s, worker, this.delayError, this.prefetch));
        } else {
            this.source.subscribe((FlowableSubscriber<? super T>) new ObserveOnSubscriber<Object>(s, worker, this.delayError, this.prefetch));
        }
    }
}
