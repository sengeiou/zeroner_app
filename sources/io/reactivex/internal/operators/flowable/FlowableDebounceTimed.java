...
public final class FlowableDebounceTimed<T> extends AbstractFlowableWithUpstream<T, T> {
    ...
    public void subscribeActual(Subscriber<? super T> s) {
        this.source.subscribe((FlowableSubscriber<? super T>) new DebounceTimedSubscriber<Object>(new SerializedSubscriber(s), this.timeout, this.unit, this.scheduler.createWorker()));
    }
}
