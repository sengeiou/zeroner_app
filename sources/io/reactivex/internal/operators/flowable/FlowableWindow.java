...
public final class FlowableWindow<T> extends AbstractFlowableWithUpstream<T, Flowable<T>> {
    ...
    public void subscribeActual(Subscriber<? super Flowable<T>> s) {
        if (this.skip == this.size) {
            ...
            this.source.subscribe((FlowableSubscriber<? super T>) new WindowSkipSubscriber<Object>(s, this.size, this.skip, this.bufferSize));
        } else {
            this.source.subscribe((FlowableSubscriber<? super T>) new WindowOverlapSubscriber<Object>(s, this.size, this.skip, this.bufferSize));
        }
    }
}
