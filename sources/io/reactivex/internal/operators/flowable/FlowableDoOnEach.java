...
public final class FlowableDoOnEach<T> extends AbstractFlowableWithUpstream<T, T> {
    ...
    public void subscribeActual(Subscriber<? super T> s) {
        if (s instanceof ConditionalSubscriber) {
            this.source.subscribe((FlowableSubscriber<? super T>) new DoOnEachConditionalSubscriber<Object>((ConditionalSubscriber) s, this.onNext, this.onError, this.onComplete, this.onAfterTerminate));
            return;
        }
        this.source.subscribe((FlowableSubscriber<? super T>) new DoOnEachSubscriber<Object>(s, this.onNext, this.onError, this.onComplete, this.onAfterTerminate));
    }
}
