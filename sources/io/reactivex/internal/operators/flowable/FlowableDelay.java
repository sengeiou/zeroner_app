...
public final class FlowableDelay<T> extends AbstractFlowableWithUpstream<T, T> {
    ...
    static final class DelaySubscriber<T> implements FlowableSubscriber<T>, Subscription {
        ...
        DelaySubscriber(Subscriber<? super T> actual2, long delay2, TimeUnit unit2, Worker w2, boolean delayError2) {
            this.actual = actual2;
            this.delay = delay2;
            this.unit = unit2;
            this.w = w2;
    ...
    public void subscribeActual(Subscriber<? super T> t) {
        ...
        this.source.subscribe((FlowableSubscriber<? super T>) new DelaySubscriber<Object>(s, this.delay, this.unit, this.scheduler.createWorker(), this.delayError));
    }
}
