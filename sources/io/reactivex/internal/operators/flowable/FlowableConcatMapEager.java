...
public final class FlowableConcatMapEager<T, R> extends AbstractFlowableWithUpstream<T, R> {
    ...
    public void subscribeActual(Subscriber<? super R> s) {
        this.source.subscribe((FlowableSubscriber<? super T>) new ConcatMapEagerDelayErrorSubscriber<Object>(s, this.mapper, this.maxConcurrency, this.prefetch, this.errorMode));
    }
}
