...
public abstract class Completable implements CompletableSource {
    ...
    public final <T> Observable<T> andThen(ObservableSource<T> next) {
        ...
        return RxJavaPlugins.onAssembly((Observable<T>) new CompletableAndThenObservable<T>(this, next));
    }
    ...
    public final <T> Flowable<T> andThen(Publisher<T> next) {
        ObjectHelper.requireNonNull(next, "next is null");
        return RxJavaPlugins.onAssembly((Flowable<T>) new CompletableAndThenPublisher<T>(this, next));
    }
