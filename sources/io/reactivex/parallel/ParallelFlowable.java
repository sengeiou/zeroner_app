...
public abstract class ParallelFlowable<T> {
    ...
    public static <T> ParallelFlowable<T> from(@NonNull Publisher<? extends T> source, int parallelism, int prefetch) {
        ObjectHelper.requireNonNull(source, SocialConstants.PARAM_SOURCE);
    ...
    public final ParallelFlowable<T> doOnNext(@NonNull Consumer<? super T> onNext) {
        ...
        return RxJavaPlugins.onAssembly((ParallelFlowable<T>) new ParallelPeek<T>(this, onNext, Functions.emptyConsumer(), Functions.emptyConsumer(), Functions.EMPTY_ACTION, Functions.EMPTY_ACTION, Functions.emptyConsumer(), Functions.EMPTY_LONG_CONSUMER, Functions.EMPTY_ACTION));
    }
    ...
    public final ParallelFlowable<T> doAfterNext(@NonNull Consumer<? super T> onAfterNext) {
        ...
        return RxJavaPlugins.onAssembly((ParallelFlowable<T>) new ParallelPeek<T>(this, Functions.emptyConsumer(), onAfterNext, Functions.emptyConsumer(), Functions.EMPTY_ACTION, Functions.EMPTY_ACTION, Functions.emptyConsumer(), Functions.EMPTY_LONG_CONSUMER, Functions.EMPTY_ACTION));
    }
    ...
    public final ParallelFlowable<T> doOnError(@NonNull Consumer<Throwable> onError) {
        ...
        return RxJavaPlugins.onAssembly((ParallelFlowable<T>) new ParallelPeek<T>(this, Functions.emptyConsumer(), Functions.emptyConsumer(), onError, Functions.EMPTY_ACTION, Functions.EMPTY_ACTION, Functions.emptyConsumer(), Functions.EMPTY_LONG_CONSUMER, Functions.EMPTY_ACTION));
    }
    ...
    public final ParallelFlowable<T> doOnComplete(@NonNull Action onComplete) {
        ...
        return RxJavaPlugins.onAssembly((ParallelFlowable<T>) new ParallelPeek<T>(this, Functions.emptyConsumer(), Functions.emptyConsumer(), Functions.emptyConsumer(), onComplete, Functions.EMPTY_ACTION, Functions.emptyConsumer(), Functions.EMPTY_LONG_CONSUMER, Functions.EMPTY_ACTION));
    }
    ...
    public final ParallelFlowable<T> doAfterTerminated(@NonNull Action onAfterTerminate) {
        ...
        return RxJavaPlugins.onAssembly((ParallelFlowable<T>) new ParallelPeek<T>(this, Functions.emptyConsumer(), Functions.emptyConsumer(), Functions.emptyConsumer(), Functions.EMPTY_ACTION, onAfterTerminate, Functions.emptyConsumer(), Functions.EMPTY_LONG_CONSUMER, Functions.EMPTY_ACTION));
    }
    ...
    public final ParallelFlowable<T> doOnSubscribe(@NonNull Consumer<? super Subscription> onSubscribe) {
        ...
        return RxJavaPlugins.onAssembly((ParallelFlowable<T>) new ParallelPeek<T>(this, Functions.emptyConsumer(), Functions.emptyConsumer(), Functions.emptyConsumer(), Functions.EMPTY_ACTION, Functions.EMPTY_ACTION, onSubscribe, Functions.EMPTY_LONG_CONSUMER, Functions.EMPTY_ACTION));
    }
    ...
    public final ParallelFlowable<T> doOnRequest(@NonNull LongConsumer onRequest) {
        ...
        return RxJavaPlugins.onAssembly((ParallelFlowable<T>) new ParallelPeek<T>(this, Functions.emptyConsumer(), Functions.emptyConsumer(), Functions.emptyConsumer(), Functions.EMPTY_ACTION, Functions.EMPTY_ACTION, Functions.emptyConsumer(), onRequest, Functions.EMPTY_ACTION));
    }
    ...
    public final ParallelFlowable<T> doOnCancel(@NonNull Action onCancel) {
        ...
        return RxJavaPlugins.onAssembly((ParallelFlowable<T>) new ParallelPeek<T>(this, Functions.emptyConsumer(), Functions.emptyConsumer(), Functions.emptyConsumer(), Functions.EMPTY_ACTION, Functions.EMPTY_ACTION, Functions.emptyConsumer(), Functions.EMPTY_LONG_CONSUMER, onCancel));
    }
    ...
    public final <R> ParallelFlowable<R> flatMap(@NonNull Function<? super T, ? extends Publisher<? extends R>> mapper, boolean delayError, int maxConcurrency, int prefetch) {
        ...
        ObjectHelper.verifyPositive(prefetch, "prefetch");
        return RxJavaPlugins.onAssembly((ParallelFlowable<T>) new ParallelFlatMap<T>(this, mapper, delayError, maxConcurrency, prefetch));
    }
