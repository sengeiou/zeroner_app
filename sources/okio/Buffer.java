...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable, ByteChannel {
    ...
    public int readInt() {
        ...
        int pos4 = pos3 + 1;
        int pos5 = pos4 + 1;
        byte b = ((data[pos] & UnsignedBytes.MAX_VALUE) << Ascii.CAN) | ((data[pos2] & UnsignedBytes.MAX_VALUE) << 16) | ((data[pos3] & UnsignedBytes.MAX_VALUE) << 8) | (data[pos4] & UnsignedBytes.MAX_VALUE);
        this.size -= 4;
        if (pos5 == limit) {
            this.head = segment.pop();
            SegmentPool.recycle(segment);
    ...
    public int readUtf8CodePoint() throws EOFException {
        ...
        int b0 = getByte(0);
        if ((b0 & 128) == 0) {
            codePoint = b0 & Opcodes.NEG_FLOAT;
            byteCount = 1;
            min = 0;
        ...
        if (string == null) {
            ...
            while (true) {
                ...
                if (c < 128) {
                    ...
                    writeByte((c >> 6) | Opcodes.AND_LONG_2ADDR);
                    writeByte((c & 63) | 128);
                    i = i2 + 1;
    ...
    public Buffer writeUtf8CodePoint(int codePoint) {
        if (codePoint < 128) {
            ...
            writeByte((codePoint >> 6) | Opcodes.AND_LONG_2ADDR);
            writeByte((codePoint & 63) | 128);
